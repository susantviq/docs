...
In StagingPro V2 scheduling is no longer a Settings feature, and it is no longer limited to the Premium tier. Every migration screen has a **Schedule for later** button next to **Start**, and scheduled migrations live in **Migration History** with their own details, reschedule and cancel. See [Scheduled migrations](/vortex-apps/staging-pro/scheduled-migrations).
