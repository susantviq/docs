...
4. **Migration History**, a permanent audit trail of every migration and deployment, with itemised issue logs, plus one-click theme rollback from the Code Deployments tab.

Bulk, selective and True Replica migrations can also be [scheduled for later](/vortex-apps/staging-pro/scheduled-migrations): a date, a time and a timezone, with StagingPro starting the run for you and emailing you about the outcome.
...
| [Migration history](/vortex-apps/staging-pro/migration-history) | Migration audit trail, scheduled rows, run detail and issue logs, theme rollback via Code Deployments |
...
| [Scheduled migrations](/vortex-apps/staging-pro/scheduled-migrations) | Schedule a migration for a date, time and timezone; waiting, missed and could-not-start outcomes; the emails |
| [Settings and configuration](/vortex-apps/staging-pro/settings-and-scheduling) | Settings tabs, agency access |
