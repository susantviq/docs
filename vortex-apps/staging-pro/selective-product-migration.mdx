...
The options popup also offers **Hide products on the destination**: every product the run creates or updates lands hidden on the destination, so you can migrate to a production store ahead of a launch and review before going live. The option and the products table's **Visible** column are described under [Products on the Selective Content Migration page](/vortex-apps/staging-pro/selective-content-migration#products).
