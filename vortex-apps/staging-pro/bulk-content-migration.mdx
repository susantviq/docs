...
> **<kbd>Channel Mapping:</kbd>** You can map the source store channels with the destination store channels prior to the migration so as to enable you to migrate the entities to corresponding destination channels. 
>
