...
<Accordion title="Nerve Centre cards">
  Cards belonging to connectors outside the active Profile are not queried. Ask Viq only reads the card catalogue for the connectors your Profile contains.
</Accordion>
