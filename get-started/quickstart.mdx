...
<Tabs>
  ...
  <Tab title="Other platforms">
    Shopify, BigCommerce, and Adobe Commerce cover roughly 80% of merchant signups, but Vortex IQ connects to over 200 integrations in total.
...
| High | 23 SKUs out of stock with active Google Ads spend | Cross-platform |
...
<Steps>
  <Step title="Select a Profile">
    Use the **Profile** dropdown at the top of the Ask Viq panel. A Profile is a saved set of connectors (for example, _Marketing profile_ = GA4 \+ Google Ads \+ Klaviyo \+ Shopify). If you have just connected your first source, a default profile is available. Select it.
  </Step>
  <Step title="Type your first question">
    Ask something grounded in your connected data, for example:

    - _"How did revenue compare last week versus the week before?"_
    - _"Which products had the biggest drop in conversion this month?"_
    - _"What is the top reason customers are abandoning checkout right now?"_
