...
description: "Nerve Centre is Vortex IQ's live KPI dashboard: 6,034 cards across 215 connectors and 11 connector types for a real-time view of your entire ecommerce operation."
---
...
At the time of writing, the catalogue contains **6,034 cards** across **215 connectors**. Cards are grouped under **[11 connector types](/nerve-centre/connectors#connectors-by-type)** that reflect the kind of data each connector provides.
...
<CardGroup cols={3}>
  ...
  <Card title="Connectors" icon="plug" href="/nerve-centre/connectors">
    The 215 connectors, organised by type, and how to connect a new source.
  </Card>
</CardGroup>
