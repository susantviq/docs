...
{/* HUMAN_AUTHORED:faqs */}
**Why is this card cross-platform?**
Because it joins data from two different connectors: Datadog (latency from APM) and the commerce platform (orders/min). The "cross" in cross-platform refers to the type of data, not multiple checkout services. This is one of the most powerful patterns Vortex IQ enables: the cause-and-effect link between technical performance and business outcomes is invisible inside any single tool but obvious when their data is overlaid.
