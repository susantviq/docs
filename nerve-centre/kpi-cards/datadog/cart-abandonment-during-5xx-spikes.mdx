...
This card is a Vortex IQ-only synthesis. No observability platform computes it natively because they do not have commerce-platform abandonment data; commerce platforms have abandonment but not 5xx-rate correlation. The cross-platform join is the value. To replicate elsewhere requires joining 5xx-rate spikes with commerce-platform abandonment in a third tool with timezone-aligned arithmetic. Vortex IQ does this automatically for connected accounts.
