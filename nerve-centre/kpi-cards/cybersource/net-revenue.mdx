---
title: "Net Revenue (after refunds + fees), CyberSource"
sidebarTitle: "Net Revenue (after refunds + fees)"
description: "Net Revenue (after refunds + fees) for CyberSource stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Net Revenue (after refunds + fees) update?**
...
**Q: How does Net Revenue (after refunds + fees) relate to other revenue & sales metrics?**
...
*Net Revenue (after refunds + fees)* is one of hundreds of KPI pulses Vortex IQ tracks across CyberSource and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
