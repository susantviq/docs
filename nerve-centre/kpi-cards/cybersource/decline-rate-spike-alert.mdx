...
| [Decline Spike vs Checkout Funnel Drop](/nerve-centre/kpi-cards/cybersource/decline-spike-vs-checkout-funnel-drop) | Cross-platform: is the spike costing revenue or being absorbed? |
...
| --- | --- | --- |
| `cs_alert_decline_spike` ↔ [`cs_xc_decline_vs_funnel`](/nerve-centre/kpi-cards/cybersource/decline-spike-vs-checkout-funnel-drop) | When this alert fires, the cross-platform card lights up within the same 60-90 second cycle. | n/a (causal). |
