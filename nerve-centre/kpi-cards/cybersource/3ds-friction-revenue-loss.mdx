...
| [Recoverable Revenue (decline-driven)](/nerve-centre/kpi-cards/cybersource/recoverable-revenue) | The decline-side companion. Decline + 3DS friction together cover most cross-platform revenue loss. |
...
| `cs_xc_3ds_friction_loss` ↔ [`cs_xc_recoverable_revenue`](/nerve-centre/kpi-cards/cybersource/recoverable-revenue) | Different friction sources (3DS vs decline). Both are real cross-platform revenue loss for an enterprise merchant. Sum them for total payment-friction-driven revenue loss. | n/a (independent). |
