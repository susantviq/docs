...
| [Recoverable Revenue (decline-driven)](/nerve-centre/kpi-cards/cybersource/recoverable-revenue) | The decline-side cross-platform companion. |
...
| [3DS Friction Revenue Loss](/nerve-centre/kpi-cards/cybersource/3ds-friction-revenue-loss) | The 3DS-side cross-platform revenue loss. |
...
| `cs_xc_disputes_to_returns` ↔ [`cs_xc_recoverable_revenue`](/nerve-centre/kpi-cards/cybersource/recoverable-revenue) | Different friction sources (returns-flow failure vs decline-driven). Both contribute to total cross-platform revenue loss. | Independent. |
