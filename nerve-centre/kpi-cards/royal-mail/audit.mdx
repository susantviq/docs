...
sidebarTitle: "Audit"
description: "What the Vortex IQ Royal Mail health audit checks: Royal Mail: Tracked24/48 SLA, P58 Claims, Handover Failure & Cross-Platform Leak"
---
...
- Cross-platform: 3PL-vs-carrier delay attribution (ShipBob warehouse-handover vs Royal Mail in-transit) -> who owns the late delivery
- Cross-platform: open P58 claims with no Jira tracker_item -> CS coverage gap (silent unhappy customers)
- Cross-platform: late-delivery refund-propensity * sibling.order.total -> $ exposed to chargeback / churn this week
- Cross-platform: untracked-service (OLA/OLP) shipments to high-LTV customers -> proactive tracking-upsell candidates
