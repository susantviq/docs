...
sidebarTitle: "Audit"
description: "What the Vortex IQ Alibris health audit checks: Alibris: FTP Feed Health, Listing Visibility & Cross-Platform ISBN Leak"
---
...
### Cross-platform: leak vs AbeBooks + Amazon (the killer area)
