...
Yes, the co-occurrence alert threshold is configurable per profile in the Alert Rules tab. Tune what counts as "slow" and "frustrated" to your own standards.
{/* /HUMAN_AUTHORED:faqs */}
