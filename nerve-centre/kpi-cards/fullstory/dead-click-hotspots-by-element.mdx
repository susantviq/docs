...
This is a ranked table rather than a single threshold metric, but the underlying dead-click alert threshold is configurable per profile in the Alert Rules tab.
{/* /HUMAN_AUTHORED:faqs */}
