...
This is a ranked table rather than a single threshold metric, but the underlying dead-click sensitivity is configurable per profile in the Sensitivity tab.
{/* /HUMAN_AUTHORED:faqs */}
