---
title: "Top Non-Branded Search Terms, Amazon (Selling Partner)"
sidebarTitle: "Top Non-Branded Search Terms"
description: "Discovery keywords your brand should defend / expand on. SEO + ad-targeting input. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `amzn_top_non_branded_keywords` |
...
| --- | --- |
| [`amzn_conversion_rank`](/nerve-centre/kpi-cards/amazon/asin-conversion-rank-by-query) | Brand Analytics & Search sibling: ASIN Conversion Rank by Query. |
| [`amzn_organic_vs_ad_share`](/nerve-centre/kpi-cards/amazon/organic-vs-ad-sales-share) | Brand Analytics & Search sibling: Organic vs Ad Sales Share. |
| [`amzn_search_query_share`](/nerve-centre/kpi-cards/amazon/search-query-share) | Brand Analytics & Search sibling: Search Query Share (Brand). |
| [`amzn_top_branded_keywords`](/nerve-centre/kpi-cards/amazon/top-branded-search-terms) | Brand Analytics & Search sibling: Top Branded Search Terms. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Top Non-Branded Search Terms update?**
...
**Q: How does Top Non-Branded Search Terms relate to other brand analytics & search metrics?**
...
*Top Non-Branded Search Terms* is one of hundreds of KPI pulses Vortex IQ tracks across Amazon (Selling Partner) and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
