---
title: "Star Rating Drift (top-50 revenue), Amazon (Selling Partner)"
sidebarTitle: "Star Rating Drift (top-50 revenue)"
description: "Star Rating Drift (top-50 revenue) for Amazon (Selling Partner) stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to ..."
---
...
{/* HUMAN_AUTHORED:tldr */}
> **Star Rating Drift (top-50 revenue)** is a voice of customer metric tracked from Amazon (Selling Partner) data. It surfaces operational signal at the voice of customer layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the Voice of Customer category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | Star Rating Drift (top-50 revenue) as exposed by the Amazon (Selling Partner) integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Currency** | decimal |
| **Time window** | `90D` |
| **Alert trigger** | `drop >0.3 stars on any top-20 ASIN` |
| **Sentiment key** | `amzn_star_rating_drift` |
...
| --- | --- |
| [`amzn_return_rate`](/nerve-centre/kpi-cards/amazon/return-rate) | Voice of Customer sibling: Return Rate. |
| [`amzn_return_reason_cluster`](/nerve-centre/kpi-cards/amazon/return-reason-clusters-by-asin) | Voice of Customer sibling: Return Reason Clusters by ASIN. |
| [`amzn_review_velocity`](/nerve-centre/kpi-cards/amazon/review-velocity) | Voice of Customer sibling: Review Velocity (30d). |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Star Rating Drift (top-50 revenue) update?**
...
**Q: How does Star Rating Drift (top-50 revenue) relate to other voice of customer metrics?**
...
*Star Rating Drift (top-50 revenue)* is one of hundreds of KPI pulses Vortex IQ tracks across Amazon (Selling Partner) and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
