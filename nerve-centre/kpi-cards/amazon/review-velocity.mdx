---
title: "Review Velocity (30d), Amazon (Selling Partner)"
sidebarTitle: "Review Velocity (30d)"
description: "Slowing review velocity = SEO / discoverability erosion. How to read it, why it matters, and how to act on it."
---
...
> Slowing review velocity = SEO / discoverability erosion.

## At a glance

{/* HUMAN_AUTHORED:tldr */}
> **Review Velocity (30d)** is a voice of customer metric tracked from Amazon (Selling Partner) data. It surfaces operational signal at the voice of customer layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the Voice of Customer category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | Review Velocity (30d) as exposed by the Amazon (Selling Partner) integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Sentiment key** | `amzn_review_velocity` |
...
| [`amzn_star_rating_drift`](/nerve-centre/kpi-cards/amazon/star-rating-drift) | Voice of Customer sibling: Star Rating Drift (top-50 revenue). |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Review Velocity (30d) update?**
...
**Q: How does Review Velocity (30d) relate to other voice of customer metrics?**
...
*Review Velocity (30d)* is one of hundreds of KPI pulses Vortex IQ tracks across Amazon (Selling Partner) and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
