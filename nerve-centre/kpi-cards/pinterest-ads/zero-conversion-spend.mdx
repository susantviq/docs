...
| [Google Ads Zero-Conversion Spend](/nerve-centre/kpi-cards/google-ads/zero-conversion-spend) | Peer ad-platform card. Cross-platform zombie-campaign audits. |
{/* /HUMAN_AUTHORED:siblings */}
...
| [`google_ads.gads_zero_conversion_spend`](/nerve-centre/kpi-cards/google-ads/zero-conversion-spend) | Peer card | Different attribution mechanics; not a reconciliation. Useful for cross-platform zombie-campaign audits. |
...
2. **The audience is browsing/saving for future life events** (wedding, home purchase, new baby) that may convert in 6+ months. This is structurally beyond Pinterest's 60-day attribution window. Run as Brand Awareness objective; don't expect conversions; measure cross-platform halo via brand-search lift in Google.
