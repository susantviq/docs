...
| **Why it is cross-platform** | Feed health lives in your feed-management layer (Feedonomics or equivalent) and your commerce platform; the Shopping distribution and Verified Merchant status live on Pinterest. The card joins the two so a feed problem is read in terms of the Pinterest revenue it endangers. |
