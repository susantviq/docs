...
| [Google Ads Spend vs Budget](/nerve-centre/kpi-cards/google-ads/spend-vs-budget) | Peer ad-platform pacing card. Useful for cross-platform budget reallocation discussions. |
{/* /HUMAN_AUTHORED:siblings */}
...
This card is the most operationally important Key Metric on Pinterest specifically because of the silent-pause behaviour.
