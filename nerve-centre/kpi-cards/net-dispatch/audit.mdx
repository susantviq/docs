...
sidebarTitle: "Audit"
description: "What the Vortex IQ NetDispatch health audit checks: NetDispatch: Dispatch-to-Collection SLA, Sub-Carrier Health & Cross-Platform Leak"
---
...
- Cross-platform: dispatch-to-collection lag correlated with order_ref - which channels are slowest
