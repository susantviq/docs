...
The default fires below the 99% Target partner SLA, and you can adjust the warning level per store on the Sensitivity tab, for example to alert earlier as you approach the ~97% review point.
