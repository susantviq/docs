...
Yes. The default fires on any value above zero, and the threshold can be adjusted per store on the Sensitivity tab if you prefer to alert only above a tolerance.
