...
| **Channel / source treatment** | **Cross-platform by definition.** This card exists precisely to compare the POS and Square Online view of the same item at the same location. It is meaningless for a single-channel merchant. |
