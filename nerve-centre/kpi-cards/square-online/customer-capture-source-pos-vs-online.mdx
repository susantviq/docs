...
description: "Customer Capture Source (POS vs Online): where each customer was first captured, retail, web, or invoice. The channel-of-first-touch view for cross-platform attribution. How to read it, why it matters, and how to act on it."
---
