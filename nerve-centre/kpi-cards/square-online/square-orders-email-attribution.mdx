...
| **Channel / source treatment** | **Cross-platform by definition.** It joins Square Orders (revenue, customer `email_address`) to your email platform's contact and engagement data. Meaningless without an email connector configured. |
