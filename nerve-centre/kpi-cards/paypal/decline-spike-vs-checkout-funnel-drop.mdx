...
| --- | --- |
| [PP Decline Rate](/nerve-centre/kpi-cards/paypal/decline-failure-rate) | The PayPal-side absolute view. This card adds the cross-platform correlation. |
...
This card is *Vortex IQ-derived*, neither PayPal nor your commerce platform offers a native cross-platform correlation alert. The closest equivalent is manually overlaying PayPal Activity and Shopify checkout-funnel charts in the same time period, which is what merchants did before this card existed.
