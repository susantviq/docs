...
| [`pp_xc_chargeback_forecast`](/nerve-centre/kpi-cards/paypal/chargeback-risk-forecast) | Cross-platform forecast combining PayPal dispute rate, Stripe dispute rate, and fraud signal velocity. |
