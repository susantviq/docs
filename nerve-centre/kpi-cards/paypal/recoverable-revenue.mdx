...
| --- | --- |
| [PP Recoverable Declines](/nerve-centre/kpi-cards/paypal/recoverable-declines) | The connector-only count view. This card is the cross-platform dollar-weighted forecast. |
