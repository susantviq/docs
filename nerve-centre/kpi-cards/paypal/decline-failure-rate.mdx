...
| [PP XC Decline vs Funnel](/nerve-centre/kpi-cards/paypal/decline-spike-vs-checkout-funnel-drop) | Cross-channel: overlay decline spikes against checkout-funnel drops. A correlated drop confirms the decline is hurting revenue, not just churn. |
