---
title: "Recurring Charge Failure Rate, PayPal"
sidebarTitle: "Recurring Charge Failure Rate"
description: "Recurring Charge Failure Rate for PayPal stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `>12%` |
| **Sentiment key** | `pp_recurring_failure_rate` |
...
| --- | --- |
| [`pp_active_subscriptions`](/nerve-centre/kpi-cards/paypal/active-subscriptions) | Subscription & Recurring sibling: Active Subscriptions. |
| [`pp_dunning_recovery_rate`](/nerve-centre/kpi-cards/paypal/dunning-recovery-rate) | Subscription & Recurring sibling: Dunning Recovery Rate. |
| [`pp_subscription_churn`](/nerve-centre/kpi-cards/paypal/subscription-churn-rate) | Subscription & Recurring sibling: Subscription Churn Rate. |
...
*Recurring Charge Failure Rate* is one of hundreds of KPI pulses Vortex IQ tracks across PayPal and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
