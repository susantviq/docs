...
| [PP XC Decline vs Funnel](/nerve-centre/kpi-cards/paypal/decline-spike-vs-checkout-funnel-drop) | Cross-platform: confirms the spike is hitting real customers (funnel drops) not just blocked attempts. |
