---
title: "Subscription Churn Rate, PayPal"
sidebarTitle: "Subscription Churn Rate"
description: "Subscription Churn Rate for PayPal stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `>5%` |
| **Sentiment key** | `pp_subscription_churn` |
...
| [`pp_recurring_failure_rate`](/nerve-centre/kpi-cards/paypal/recurring-charge-failure-rate) | Subscription & Recurring sibling: Recurring Charge Failure Rate. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Subscription Churn Rate update?**
...
**Q: How does Subscription Churn Rate relate to other subscription & recurring metrics?**
...
*Subscription Churn Rate* is one of hundreds of KPI pulses Vortex IQ tracks across PayPal and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
