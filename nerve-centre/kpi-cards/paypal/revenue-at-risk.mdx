...
| [PP XC Decline vs Funnel](/nerve-centre/kpi-cards/paypal/decline-spike-vs-checkout-funnel-drop) | Cross-platform: confirms whether the decline spike is hitting real customers (funnel drops) or just blocked attempts. |
