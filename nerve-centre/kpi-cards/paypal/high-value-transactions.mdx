---
title: "High-Value Transactions, PayPal"
sidebarTitle: "High-Value Transactions"
description: "High-Value Transactions for PayPal stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Sentiment key** | `pp_high_value_transactions` |
...
| [`pp_net_revenue`](/nerve-centre/kpi-cards/paypal/net-revenue) | Revenue & Sales sibling: Net Revenue (after refunds + PayPal fees). |
...
*High-Value Transactions* is one of hundreds of KPI pulses Vortex IQ tracks across PayPal and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
