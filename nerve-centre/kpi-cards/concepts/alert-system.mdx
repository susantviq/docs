...
Data-gap alerts route to the workspace administrator role rather than the card's domain owner, because the fix is almost always a connection re-authorisation rather than a business decision.
