...
| **Time window** | `RT` (real-time). The cross-platform join refreshes every 5-10 minutes during business hours. |
...
Yes. The cross-platform join is on Merchant Center product ID, not on campaign type. PMax product groups bidding on OOS SKUs surface in this card the same as Shopping campaigns.
