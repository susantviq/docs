...
| [`gads_xc_revenue_share`](/nerve-centre/kpi-cards/google-ads/google-ads-revenue-share) | Cross-platform view: low impression share might be the right choice if other channels (organic SEO, email, direct) are absorbing the demand at lower cost. |
