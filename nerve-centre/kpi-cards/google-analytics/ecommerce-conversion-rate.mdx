---
title: "Conversion Rate (Session), Google Analytics 4"
sidebarTitle: "Conversion Rate (Session)"
description: "Conversion Rate (Session) for Google Analytics 4 stores. The single most-watched GA4 number. Drops here are the cleanest canary for checkout / GTM regressions. How to read it, why it matters, and how to act on it."
---
