...
| [`ic_xc_complaints_on_oos`](/nerve-centre/kpi-cards/intercom/complaints-on-out-of-stock-skus) | Joins stock/refund-tagged conversations to inventory — the cross-platform version of a stock topic. |
...
Yes. The "+50% week over week on any tag" trigger is configurable per profile in the Alert Rules tab. Raise it if a few low-volume tags create noisy alerts, or lower it to catch emerging issues sooner.
{/* /HUMAN_AUTHORED:faqs */}
