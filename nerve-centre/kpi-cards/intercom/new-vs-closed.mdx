...
Yes. The "closed &lt; new for 7 days" rule is configurable per profile in the Alert Rules tab — tighten the day count for a faster warning or loosen it to reduce noise.
{/* /HUMAN_AUTHORED:faqs */}
