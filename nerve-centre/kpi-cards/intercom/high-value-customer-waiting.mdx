...
description: "Cross-platform live table of top-decile-LTV customers whose open Intercom conversation is breaching SLA right now. How to read it, why it matters, and how to act on it."
---
...
| [`ic_xc_support_spike_failed_payments`](/nerve-centre/kpi-cards/intercom/support-spike-on-failed-payments) | Cross-platform sibling: a waiting VIP may also be a refused-payment shopper. |
| [`ic_xc_complaints_on_oos`](/nerve-centre/kpi-cards/intercom/complaints-on-out-of-stock-skus) | Cross-platform sibling: the VIP may be waiting on a sold-out item you can recover. |
...
Yes. The default alert fires whenever any top-decile customer breaches SLA; you can widen the value cohort (for example to the top two deciles) or tighten the SLA target per profile in the Alert Rules tab.
{/* /HUMAN_AUTHORED:faqs */}
