...
Yes. The `>240 min` trigger is configurable per profile in the Alert Rules tab. Set it to your published first-response target rather than the generic default.
{/* /HUMAN_AUTHORED:faqs */}
