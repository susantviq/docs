...
Yes. The default alert fires above zero, but the alert threshold is configurable per profile in the Alert Rules tab — raise it if a low baseline of genuine declines is normal for Blitz.
{/* /HUMAN_AUTHORED:faqs */}
