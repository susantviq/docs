...
description: "Cross-channel count of Intercom conversations opened by shoppers whose Adyen payments were refused in the last 7 days. How to read it, why it matters, and how to act on it."
---
...
| --- | --- |
| [`ic_xc_high_value_waiting`](/nerve-centre/kpi-cards/intercom/high-value-customer-waiting) | Cross-channel sibling: are any of these refused-payment shoppers also high-LTV customers breaching SLA right now? |
| [`ic_xc_support_load_per_100_orders`](/nerve-centre/kpi-cards/intercom/support-contacts-per-100-orders) | Cross-channel sibling: a payment spike inflates contacts-per-100-orders — confirm the macro signal. |
