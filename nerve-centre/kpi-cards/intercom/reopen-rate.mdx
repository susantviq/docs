...
Yes. The `>15%` trigger is configurable per profile in the Alert Rules tab. Lower it if your category (for example, simple order-status queries) should rarely reopen.
{/* /HUMAN_AUTHORED:faqs */}
