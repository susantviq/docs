...
description: "Cross-platform table joining Intercom complaint conversations to commerce SKUs that are currently out of stock. How to read it, why it matters, and how to act on it."
---
...
| [`ic_xc_support_load_per_100_orders`](/nerve-centre/kpi-cards/intercom/support-contacts-per-100-orders) | Cross-platform sibling: a wave of stock complaints lifts contacts-per-100-orders. |
| [`ic_xc_high_value_waiting`](/nerve-centre/kpi-cards/intercom/high-value-customer-waiting) | Cross-platform sibling: are any complainants high-LTV customers waiting past SLA? |
...
Yes. The default alert fires whenever any out-of-stock SKU has complaints; sensitivity is configurable per profile in the Alert Rules tab if you want to surface only SKUs above a complaint count.
{/* /HUMAN_AUTHORED:faqs */}
