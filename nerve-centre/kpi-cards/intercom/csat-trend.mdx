...
Yes. The >5-point week-over-week drop is configurable per profile in the Alert Rules tab. If Blitz runs a noisier baseline during sale events, widen it to cut false positives.
{/* /HUMAN_AUTHORED:faqs */}
