...
Yes. The `>0` trigger is configurable per profile in the Alert Rules tab. Many teams set it to `>3` to suppress the normal transient churn and only alert on genuine pile-ups.
{/* /HUMAN_AUTHORED:faqs */}
