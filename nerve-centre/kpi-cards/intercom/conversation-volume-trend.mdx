...
This card itself has no threshold — it is a read-only trend. Use **Volume Spike** for the anomaly alert, which is configurable per profile in the Alert Rules tab.
{/* /HUMAN_AUTHORED:faqs */}
