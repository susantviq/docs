...
Yes. The ">20% week-over-week rise" trigger is configurable per profile in the Alert Rules tab. Lower it for an earlier warning or raise it if your volume is naturally spiky.
{/* /HUMAN_AUTHORED:faqs */}
