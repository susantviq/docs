...
Yes. The `drop >5pts` trigger is configurable per profile in the Alert Rules tab — tighten it for a high-volume desk where small moves are meaningful, or loosen it for a low-volume queue where the score is naturally jumpy.
{/* /HUMAN_AUTHORED:faqs */}
