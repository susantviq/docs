...
This card has no default threshold, but you can add a sensitivity rule per profile in the Sensitivity tab to flag when the average drifts above your normal baseline.
{/* /HUMAN_AUTHORED:faqs */}
