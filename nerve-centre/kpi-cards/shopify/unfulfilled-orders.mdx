...
| [Revenue at Risk (live incident)](/nerve-centre/kpi-cards/shopify/revenue-at-risk) | When ops outage drives this number above 50 with an open Datadog/NewRelic incident, the cross-platform card surfaces £/min impact. |
{/* /HUMAN_AUTHORED:siblings */}
