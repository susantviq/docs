...
2. **The Critical Low band is the future problem.** 96 variants at 1-5 units. At normal velocity, half of these will OOS within 7 days. This is where reorder POs need to land first.
