...
| **Unique customers (this card)** | | **4,712** (after cross-platform dedup) | |
...
1. **Cross-platform dedup is real.** 491 customers (5,203 - 4,712) bought across more than one channel, e.g. POS visit + online repeat, or Online + Buy Button. They count once. This is why summing per-channel customer counts overstates the unique base.
