...
| [`google_analytics.ga_purchases_trend`](/nerve-centre/kpi-cards/google-analytics/purchases-trend) | Cross-channel order count | GA4 sees purchase events; Shopify sees orders; should match within 5-15% (ad blockers, cookie consent gaps). |
