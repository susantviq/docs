---
title: "Pageviews per Session, PostHog"
sidebarTitle: "Pageviews per Session"
description: "Pageviews per Session for PostHog stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| | |
| --- | --- |
| **What it counts** | Pageviews per Session as exposed by the PostHog integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Time window** | `30D` |
| **Alert trigger** | `-` |
| **Sentiment key** | `pos_pageviews_per_session` |
...
*Pageviews per Session* is one of hundreds of KPI pulses Vortex IQ tracks across PostHog and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
