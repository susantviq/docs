---
title: "Avg Session Duration, PostHog"
sidebarTitle: "Avg Session Duration"
description: "Avg Session Duration for PostHog stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| | |
| --- | --- |
| **What it counts** | Avg Session Duration as exposed by the PostHog integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Time window** | `30D` |
| **Alert trigger** | `-` |
| **Sentiment key** | `pos_avg_session_duration` |
...
*Avg Session Duration* is one of hundreds of KPI pulses Vortex IQ tracks across PostHog and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
