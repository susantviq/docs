---
title: "Bounce Rate, PostHog"
sidebarTitle: "Bounce Rate"
description: "Bounce Rate for PostHog stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| [`pos_pageviews_per_session`](/nerve-centre/kpi-cards/posthog/pageviews-per-session) | Engagement sibling: Pageviews per Session. |
| [`pos_top_pages`](/nerve-centre/kpi-cards/posthog/top-pages) | Engagement sibling: Top Pages. |
| [`pos_top_sources`](/nerve-centre/kpi-cards/posthog/top-traffic-sources) | Engagement sibling: Top Traffic Sources. |
...
*Bounce Rate* is one of hundreds of KPI pulses Vortex IQ tracks across PostHog and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
