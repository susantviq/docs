---
title: "Top Traffic Sources, PostHog"
sidebarTitle: "Top Traffic Sources"
description: "Top Traffic Sources for PostHog stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| | |
| --- | --- |
| **What it counts** | Top Traffic Sources as exposed by the PostHog integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
*Top Traffic Sources* is one of hundreds of KPI pulses Vortex IQ tracks across PostHog and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
