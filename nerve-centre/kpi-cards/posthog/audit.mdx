...
Verifies PostHog project access, event-ingestion health, engagement and retention, funnel conversion, session-replay and feature-flag hygiene, data quality, and cross-platform reconciliation against ecommerce.
