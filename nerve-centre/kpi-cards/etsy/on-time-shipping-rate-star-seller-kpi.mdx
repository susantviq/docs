...
Yes. Alert thresholds are configurable per profile in the Alert Rules tab. Many sellers set the alert above 95%, for example at 96% or 97%, so they get an early warning before they actually breach the Star Seller line.
{/* /HUMAN_AUTHORED:faqs */}
