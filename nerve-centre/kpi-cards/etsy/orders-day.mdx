...
This card ships without an alert because a daily line is descriptive. You can still add an alert rule per profile in the Alert Rules tab, for example to flag when the daily order count drops sharply below its recent average.
{/* /HUMAN_AUTHORED:faqs */}
