...
Yes. Alert thresholds are configurable per profile in the Alert Rules tab. The default alerts above 3%, but a high-volume shop may set a tighter bar since even a small percentage represents many affected buyers.
{/* /HUMAN_AUTHORED:faqs */}
