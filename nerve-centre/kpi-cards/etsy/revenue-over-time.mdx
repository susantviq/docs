...
Yes. Alert thresholds are configurable per profile in the Alert Rules tab. This card ships without an alert, but you can pair it with threshold cards like Revenue at Risk to get notified when the trend is likely to turn.
{/* /HUMAN_AUTHORED:faqs */}
