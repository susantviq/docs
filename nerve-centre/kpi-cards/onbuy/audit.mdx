...
sidebarTitle: "Audit"
description: "What the Vortex IQ OnBuy health audit checks: OnBuy: Listing Health, Fulfilment SLA & Cross-Platform Leak"
---
...
### Cross-platform: leak vs Amazon UK + DTC (the killer area)
