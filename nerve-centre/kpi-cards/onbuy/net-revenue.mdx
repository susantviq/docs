---
title: "Net Revenue (after commission + refunds), OnBuy"
sidebarTitle: "Net Revenue (after commission + refunds)"
description: "Net Revenue (after commission + refunds) for OnBuy stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| [`onbuy_commission_pct`](/nerve-centre/kpi-cards/onbuy/onbuy-commission-of-revenue) | Revenue & Sales sibling: OnBuy Commission % of Revenue. |
...
*Net Revenue (after commission + refunds)* is one of hundreds of KPI pulses Vortex IQ tracks across OnBuy and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
