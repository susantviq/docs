---
title: "OnBuy Commission % of Revenue, OnBuy"
sidebarTitle: "OnBuy Commission % of Revenue"
description: "Per-category commission tracking, flags categories where OnBuy fees outpace margin. How to read it, why it matters, and how to act on it."
---
...
> Per-category commission tracking, flags categories where OnBuy fees outpace margin.

## At a glance

{/* HUMAN_AUTHORED:tldr */}
> **OnBuy Commission % of Revenue** is a revenue & sales metric tracked from OnBuy data. It surfaces operational signal at the revenue & sales layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the Revenue & Sales category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | OnBuy Commission % of Revenue as exposed by the OnBuy integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Time window** | `30D` |
| **Alert trigger** | `>12%` |
| **Sentiment key** | `onbuy_commission_pct` |
| **Roles** | owner, finance |
{/* /HUMAN_AUTHORED:tldr */}
...
| [`onbuy_net_revenue`](/nerve-centre/kpi-cards/onbuy/net-revenue) | Revenue & Sales sibling: Net Revenue (after commission + refunds). |
| [`onbuy_order_count`](/nerve-centre/kpi-cards/onbuy/orders) | Revenue & Sales sibling: Orders. |
| [`onbuy_revenue_trend`](/nerve-centre/kpi-cards/onbuy/revenue-over-time) | Revenue & Sales sibling: Revenue Over Time. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does OnBuy Commission % of Revenue update?**
...
**Q: How does OnBuy Commission % of Revenue relate to other revenue & sales metrics?**
...
*OnBuy Commission % of Revenue* is one of hundreds of KPI pulses Vortex IQ tracks across OnBuy and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
