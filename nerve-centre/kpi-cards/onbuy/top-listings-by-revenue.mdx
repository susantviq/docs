---
title: "Top Listings by Revenue, OnBuy"
sidebarTitle: "Top Listings by Revenue"
description: "Top Listings by Revenue for OnBuy stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `onbuy_top_listings` |
...
**Q: How does Top Listings by Revenue relate to other revenue & sales metrics?**
...
*Top Listings by Revenue* is one of hundreds of KPI pulses Vortex IQ tracks across OnBuy and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
