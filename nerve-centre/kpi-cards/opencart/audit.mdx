...
Audits an OpenCart store against its Admin API - authentication and access, catalogue and inventory health, order and fulfilment health, customer and retention signals, payments and refunds, and cross-platform revenue at risk for a self-hosted install.
