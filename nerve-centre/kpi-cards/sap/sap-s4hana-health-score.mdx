...
The component set and thresholds are configurable per workspace in the Alert Rules tab. Businesses that care most about close timeliness can weight that component more; commerce-heavy shops that live and die by IDoc integration can weight that one. The default blend balances all four.
