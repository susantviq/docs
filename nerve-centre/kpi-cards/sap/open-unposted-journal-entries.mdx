...
Yes. The default fires above 50. Tune it per workspace in the Alert Rules tab. High-volume commerce shops with large daily IDoc traffic may sit at a higher healthy baseline; low-volume operations should set it lower so any stuck document is caught early.
