...
Yes. The default fires when any entity is more than five days overdue. Tune it per workspace in the Alert Rules tab. Groups with tight regulatory reporting deadlines may set a shorter tolerance; groups with many entities across far-apart time zones may allow slightly more slack.
{/* /HUMAN_AUTHORED:faqs */}
