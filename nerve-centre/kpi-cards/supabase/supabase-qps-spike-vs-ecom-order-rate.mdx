...
| [Supabase Products Table vs Ecom Catalog](/nerve-centre/kpi-cards/supabase/supabase-products-table-vs-ecom-catalog) | The other cross-platform revenue-at-risk join. | A runaway sync job can cause both a QPS spike and new catalogue drift at the same time. |
