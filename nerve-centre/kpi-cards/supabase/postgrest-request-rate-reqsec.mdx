...
| **Alert trigger** | None by default. Throughput is context, not a pass/fail signal. You can add a custom ceiling or floor in the Alert Rules tab if you want to catch traffic surges or a drop to zero. |
