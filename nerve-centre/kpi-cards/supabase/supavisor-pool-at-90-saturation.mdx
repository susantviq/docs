...
| [Supavisor Pool Saturation vs Traffic Burst](/nerve-centre/kpi-cards/supabase/supavisor-pool-saturation-vs-traffic-burst) | The cross-channel view: saturation against live traffic. | Saturation rising with traffic equals capacity problem; rising with flat traffic equals connection leak. |
