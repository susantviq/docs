...
| [Slow PostgREST Queries During Checkout Window](/nerve-centre/kpi-cards/supabase/slow-postgrest-queries-during-checkout-window) | Cross-channel view linking slow API calls to checkout drops. | Confirms whether the 5xx spike landed on the revenue path during a checkout window. |
{/* /HUMAN_AUTHORED:siblings */}
