...
This card has no default alert trigger, but you can configure sensitivity and minimum-order thresholds per profile in the Alert Rules tab if you want to be notified when a key country's AOV moves. Adjust to match your business baseline rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
