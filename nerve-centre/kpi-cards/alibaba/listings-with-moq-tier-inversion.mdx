...
Yes, alert thresholds are configurable per profile in the Alert Rules tab. The default fires above zero; you can adjust it to match your business baseline rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
