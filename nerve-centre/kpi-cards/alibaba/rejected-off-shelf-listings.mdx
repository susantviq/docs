...
Yes, alert thresholds are configurable per profile in the Alert Rules tab. The default trigger fires on any count above zero. Adjust to match your business baseline rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
