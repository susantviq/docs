...
description: "Joins shipment timing to commerce-sibling orders by order_ref - which sales channel is suffering most from carrier delays. Key Metric. How to read it, why it mat..."
---
...
> Joins shipment timing to commerce-sibling orders by order_ref - which sales channel is suffering most from carrier delays. Key Metric.

## At a glance

{/* HUMAN_AUTHORED:tldr */}
> Cross-platform OTD split: takes every DPDLocal consignment, joins it back to the originating commerce order (Shopify / BigCommerce / Adobe / SFCC sibling) by `order_ref`, and groups by the originating sales channel. Surfaces "which channel's customers are getting the worst delivery experience" so marketing can match acquisition spend to fulfilment reality.
