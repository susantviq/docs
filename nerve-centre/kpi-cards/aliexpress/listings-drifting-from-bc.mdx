...
| [`aex_xc_price_parity`](/nerve-centre/kpi-cards/aliexpress/b2b-vs-retail-pricing-coherence-vs-alibaba) | Another cross-platform pricing coherence check, this time against Alibaba B2B. |
...
It sits alongside the other cross-platform revenue-at-risk cards. Pair it with the Feedonomics validation card to see drift caused by rejected updates and with the OOS-on-BC card for the stock-drift extreme.
