...
| [Interlink OTD by Sales Channel](/nerve-centre/kpi-cards/interlink-express/interlink-otd-by-sales-channel) | Cross-platform split. A late spike concentrated in one channel = single-cohort fix. | Channel mix in the late count matches the channel mix of customer-service tickets. |
