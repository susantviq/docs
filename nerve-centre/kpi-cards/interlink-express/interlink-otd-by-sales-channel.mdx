...
| Cross-connector: [`parcelforce.parcelforce_xc_otd_by_channel`](/nerve-centre/kpi-cards/parcelforce/parcelforce-otd-by-sales-channel) | Sister cross-channel card on Parcelforce. | Multi-carrier merchants benchmark per-channel performance across carriers. |
{/* /HUMAN_AUTHORED:siblings */}
