---
title: "Repeat Purchase Rate, Salesforce Commerce Cloud"
sidebarTitle: "Repeat Purchase Rate"
description: "Repeat-customer rate &lt;20% = retention gap; feeds win-back automation kill-shot. How to read it, why it matters, and how to act on it."
---
...
{/* HUMAN_AUTHORED:tldr */}
> **Repeat Purchase Rate** is a customer health metric tracked from Salesforce Commerce Cloud data. It surfaces operational signal at the customer health layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the Customer Health category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | Repeat Purchase Rate as exposed by the Salesforce Commerce Cloud integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Time window** | `90D` |
| **Alert trigger** | `<20%` |
| **Sentiment key** | `sfcc_repeat_rate` |
...
| --- | --- |
| [`sfcc_new_customers`](/nerve-centre/kpi-cards/salesforce-commerce-cloud/new-customers) | Customer Health sibling: New Customers. |
...
*Repeat Purchase Rate* is one of hundreds of KPI pulses Vortex IQ tracks across Salesforce Commerce Cloud and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
