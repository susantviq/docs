---
title: "New Customers, Salesforce Commerce Cloud"
sidebarTitle: "New Customers"
description: "New Customers for Salesforce Commerce Cloud stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D vsP` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `sfcc_new_customers` |
...
| --- | --- |
| [`sfcc_repeat_rate`](/nerve-centre/kpi-cards/salesforce-commerce-cloud/repeat-purchase-rate) | Customer Health sibling: Repeat Purchase Rate. |
...
**Q: How does New Customers relate to other customer health metrics?**
...
*New Customers* is one of hundreds of KPI pulses Vortex IQ tracks across Salesforce Commerce Cloud and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
