...
Yes. The default is any locale below half the group average, but the threshold is configurable per profile in the Alert Rules tab. Merchants with naturally wide market variation sometimes loosen it to avoid flagging a structurally lower market; merchants with tightly comparable markets sometimes tighten it. Set it to your own baseline rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
