...
5. **Single-day cliff alert threshold.** Because cohort-anchor days are 3, 5x background days, a daily alert threshold of "drop > 25%" is meaningless on a non-anchor day (the natural variation is already 50%+ down from the cohort peak). Use the *same day-of-week vs prior period* comparison, NOT raw daily.
