...
| **Card class** | Hero and Alert Rules card: it drives the Performance health signal and both the slow threshold and the 5% alert level are configurable in the Alert Rules tab. |
{/* /HUMAN_AUTHORED:tldr */}
