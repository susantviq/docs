...
**Metrics type:** [Alert Rules](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [DBU Burn](/nerve-centre/connectors#connectors-by-type)
...
Yes. The week-over-week sensitivity is configurable per profile in the Alert Rules tab. Teams with deliberately variable workloads (seasonal loads, backfills) often widen it to avoid firing on expected swings, while cost-sensitive teams tighten it.
