...
| [DBU Burn vs Ecom Order Volume](/nerve-centre/kpi-cards/databricks/dbu-burn-vs-ecom-order-volume) | The cross-platform view of the same decoupling. | Spend up while orders flat is the business-level confirmation of inefficiency. |
