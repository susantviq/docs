...
| [Slow SQL Queries During Checkout Window](/nerve-centre/kpi-cards/databricks/slow-sql-queries-during-checkout-window) | The revenue cross-channel view. | Confirms whether the slow tail co-occurs with storefront checkout activity. |
{/* /HUMAN_AUTHORED:siblings */}
