...
Yes. The component weights and the alert threshold are configurable per profile in the Alert Rules tab. A cost-focused FinOps team may lift the DBU-efficiency weight; a team with strict SLAs may lift latency. The default weighting prioritises reliability and errors.
{/* /HUMAN_AUTHORED:faqs */}
