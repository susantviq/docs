...
| [DBU Burn vs Ecom Order Volume](/nerve-centre/kpi-cards/databricks/dbu-burn-vs-ecom-order-volume) | The cross-channel efficiency check. | Idle waste is spend that grows DBU without serving any order at all. |
{/* /HUMAN_AUTHORED:siblings */}
