...
| [Pipeline Lag vs Ecom Order Flow](/nerve-centre/kpi-cards/databricks/pipeline-lag-vs-ecom-order-flow) | The cross-platform impact of a stalled pipeline. | A critical failure while orders keep flowing is the highest-urgency combination. |
{/* /HUMAN_AUTHORED:siblings */}
