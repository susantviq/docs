...
Five un-worked repeat accounts is the point where the missed expansion revenue is worth a sales-team conversation for most merchants. High-volume B2B operations may raise it; smaller ones may lower it. Tune it in the Alert Rules tab.
