---
title: "Open Deal Pipeline Value, HubSpot"
sidebarTitle: "Open Deal Pipeline Value"
description: "Open Deal Pipeline Value: sum of amount across all open deals (excludes closed_won + closed_lost). The hero number for B2B founders. How to read it, why it matters, and how to act on it."
---
...
| [Pipeline-vs-Realised Revenue Gap](/nerve-centre/kpi-cards/hubspot/pipeline-vs-realised-revenue-gap) | The cross-platform reality check against Stripe / Shopify revenue. HubSpot's closed_won doesn't always become commerce revenue. |
{/* /HUMAN_AUTHORED:siblings */}
...
No. Open deals only. `closedwon` and `closedlost` deals are excluded. To see total bookings (closed_won), look at the Deal Pipeline-vs-Realised cross-platform card or HubSpot's own Sales analytics report.
