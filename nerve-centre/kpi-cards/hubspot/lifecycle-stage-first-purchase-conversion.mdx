...
| **HubSpot Hub scope** | All Hubs. Lifecycle stage is a contact property; the cross-platform join uses commerce-platform customer data. |
...
HubSpot does not natively expose this cross-platform rate; it requires commerce data. Closest views:
