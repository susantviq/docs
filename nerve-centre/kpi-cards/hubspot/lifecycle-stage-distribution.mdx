---
title: "Contact Lifecycle Stage Distribution, HubSpot"
sidebarTitle: "Contact Lifecycle Stage Distribution"
description: "Contact Lifecycle Stage Distribution: Subscriber → Lead → MQL → SQL → Opportunity → Customer → Evangelist counts. Sharp drop-offs flag the stage that needs work. How to read it, why it matters, and how to act on it."
---
...
| [Lifecycle Stage to First Purchase Conversion](/nerve-centre/kpi-cards/hubspot/lifecycle-stage-first-purchase-conversion) | The cross-platform reality check, lifecycle-customer should approximate commerce-customer. |
...
HubSpot lifecycle-customer is a contact attribute, not an actual purchase. A contact may be marked "customer" by a workflow, by a sales rep, or by a stale Stripe integration that did not unflag cancelled subscribers. Stripe / Shopify customers are anyone with a payment record. Use the cross-platform `Top Customers Without HubSpot Contact` card to surface the actual gap.
