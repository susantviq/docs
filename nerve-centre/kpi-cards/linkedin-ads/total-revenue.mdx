...
| [`facebook_ads.fac_total_revenue`](/nerve-centre/kpi-cards/facebook-ads/total-revenue) | Cross-platform peer. Meta will usually report higher in-window revenue because conversions land in-window for B2C-flavoured flows. | Cross-channel attribution context. |
{/* /HUMAN_AUTHORED:siblings */}
