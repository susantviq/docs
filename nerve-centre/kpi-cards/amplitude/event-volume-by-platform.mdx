...
This card has no alert trigger by default, since a healthy split varies by store. You can set sensitivity per profile in the Alert Rules tab if you want to be alerted when a platform's share moves beyond its normal range.
{/* /HUMAN_AUTHORED:faqs */}
