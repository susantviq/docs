...
This card ships without a default alert trigger, but alert thresholds are configurable per profile in the Alert Rules tab. You can add a custom threshold if you want alerts when engagement depth moves beyond your normal range.
{/* /HUMAN_AUTHORED:faqs */}
