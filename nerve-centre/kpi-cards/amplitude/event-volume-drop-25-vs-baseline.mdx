...
Yes, the 25 percent trigger and the baseline window are configurable per profile in the Alert Rules tab. Tune them to your normal daily volume variance rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
