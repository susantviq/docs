...
Yes, alert thresholds are configurable per profile in the Alert Rules tab. The default trips on a drop greater than 5 percentage points versus the 8-week baseline; adjust it to match your business baseline rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
