...
Yes, sensitivity thresholds are configurable per profile in the Sensitivity tab. The default alerts when the score falls below 70; raise or lower it to match how tolerant your team is of instrumentation noise.
{/* /HUMAN_AUTHORED:faqs */}
