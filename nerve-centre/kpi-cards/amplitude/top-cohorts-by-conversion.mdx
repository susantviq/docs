...
This card has no alert trigger by default, since a meaningful cohort rate varies by segment. You can set alert rules per profile in the Alert Rules tab if you want to be notified when a key cohort's conversion moves beyond its normal range.
{/* /HUMAN_AUTHORED:faqs */}
