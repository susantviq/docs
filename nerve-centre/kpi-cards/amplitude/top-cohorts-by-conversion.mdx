...
This card has no alert trigger by default, since a meaningful cohort rate varies by segment. You can set sensitivity per profile in the Sensitivity tab if you want to be notified when a key cohort's conversion moves beyond its normal range.
{/* /HUMAN_AUTHORED:faqs */}
