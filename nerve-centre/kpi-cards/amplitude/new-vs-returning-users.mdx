...
This card has no alert trigger by default, since the healthy mix varies by business. You can still set sensitivity per profile in the Alert Rules tab if you want to be notified when the split moves beyond your normal range.
{/* /HUMAN_AUTHORED:faqs */}
