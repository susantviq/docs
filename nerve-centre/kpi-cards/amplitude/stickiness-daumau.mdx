...
Yes, alert thresholds are configurable per profile in the Alert Rules tab. The default alerts when stickiness falls below 20%; tune it to the habit baseline normal for your category, since a daily-use product and an occasional-purchase store sit at very different levels.
{/* /HUMAN_AUTHORED:faqs */}
