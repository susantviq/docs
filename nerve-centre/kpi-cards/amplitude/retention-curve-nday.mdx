...
Yes, sensitivity thresholds are configurable per profile in the Sensitivity tab. The curve card itself is a visualisation, but the per-day retention cards carry alerts you can tune to your business baseline rather than relying on generic defaults.
{/* /HUMAN_AUTHORED:faqs */}
