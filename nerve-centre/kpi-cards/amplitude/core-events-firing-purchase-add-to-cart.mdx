...
The alert fires when any core event count reaches zero, which is the right default for a tracking canary. You can adjust the core event list and alert thresholds per profile in the Alert Rules tab to match your store's setup.
{/* /HUMAN_AUTHORED:faqs */}
