...
| [APC OTD by Sales Channel](/nerve-centre/kpi-cards/apc/apc-otd-by-sales-channel) | Cross-platform. A late spike that is all Shopify retail and zero B2B-EDI tells you it is a consumer-experience problem first. | Channel mix in the late count matches the channel mix of customer-service tickets a day later. |
