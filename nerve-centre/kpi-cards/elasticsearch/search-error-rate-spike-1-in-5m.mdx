...
Lower the threshold for your profile in the Sensitivity tab. The 1% default suits a typical store, but if your baseline error rate is normally near zero, a sustained 0.5% is already abnormal for you and worth paging on. Tune the threshold to your own baseline rather than the generic default, and pair it with the [Search Error Rate %](/nerve-centre/kpi-cards/elasticsearch/search-error-rate) gauge to watch the sub-threshold trend.
{/* /HUMAN_AUTHORED:faqs */}
