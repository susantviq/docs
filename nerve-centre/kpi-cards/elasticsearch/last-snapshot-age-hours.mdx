...
| **Alert trigger** | `> 72h`: more than three days since the last successful snapshot trips the alert threshold. Tighten this for clusters with an aggressive recovery-point objective. |
