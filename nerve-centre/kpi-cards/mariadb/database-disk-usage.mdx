...
| **Sensitivity** | Alert Rules card: the alert threshold is tunable per profile, but lowering it below 90 is more common than raising it, since fast-growing instances need more runway. |
