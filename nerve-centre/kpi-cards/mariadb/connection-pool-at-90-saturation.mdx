...
| **Severity** | High. This is a Key Metric card because exhaustion directly causes connection refusals, which break the application tier and, downstream, the storefront. |
