...
| **Alert trigger** | `> 500ms`. Above this the card turns amber and surfaces in the Alert feed. |
...
| [Slow Queries During Checkout Window (5m)](/nerve-centre/kpi-cards/mariadb/slow-queries-during-checkout-window-5m) | The revenue-at-risk cross-platform view. | A p99 outlier that lands in the checkout window is the one that abandons a basket. |
{/* /HUMAN_AUTHORED:siblings */}
