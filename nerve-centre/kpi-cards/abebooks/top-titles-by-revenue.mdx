---
title: "Top Titles by Revenue, AbeBooks"
sidebarTitle: "Top Titles by Revenue"
description: "Top books by ISBN by revenue, drives reorder-and-list-again decisions on velocity titles. How to read it, why it matters, and how to act on it."
---
...
> Top books by ISBN by revenue, drives reorder-and-list-again decisions on velocity titles.

## At a glance

{/* HUMAN_AUTHORED:tldr */}
> **Top Titles by Revenue** is a revenue & sales metric tracked from AbeBooks data. It surfaces operational signal at the revenue & sales layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the Revenue & Sales category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | Top Titles by Revenue as exposed by the AbeBooks integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| --- | --- |
| [`ab_aov`](/nerve-centre/kpi-cards/abebooks/average-order-value) | Revenue & Sales sibling: Average Order Value. |
| [`ab_net_revenue`](/nerve-centre/kpi-cards/abebooks/net-revenue) | Revenue & Sales sibling: Net Revenue (after commission + refunds). |
| [`ab_order_count`](/nerve-centre/kpi-cards/abebooks/orders) | Revenue & Sales sibling: Orders. |
| [`ab_revenue_trend`](/nerve-centre/kpi-cards/abebooks/revenue-over-time) | Revenue & Sales sibling: Revenue Over Time. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Top Titles by Revenue update?**
...
**Q: How does Top Titles by Revenue relate to other revenue & sales metrics?**
...
*Top Titles by Revenue* is one of hundreds of KPI pulses Vortex IQ tracks across AbeBooks and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
