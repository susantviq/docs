---
title: "Net Revenue (after commission + refunds), AbeBooks"
sidebarTitle: "Net Revenue (after commission + refunds)"
description: "Net Revenue (after commission + refunds) for AbeBooks stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
{/* HUMAN_AUTHORED:tldr */}
> **Net Revenue (after commission + refunds)** is a revenue & sales metric tracked from AbeBooks data. It surfaces operational signal at the revenue & sales layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the Revenue & Sales category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | Net Revenue (after commission + refunds) as exposed by the AbeBooks integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| [`ab_top_titles`](/nerve-centre/kpi-cards/abebooks/top-titles-by-revenue) | Revenue & Sales sibling: Top Titles by Revenue. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Net Revenue (after commission + refunds) update?**
...
**Q: How does Net Revenue (after commission + refunds) relate to other revenue & sales metrics?**
...
*Net Revenue (after commission + refunds)* is one of hundreds of KPI pulses Vortex IQ tracks across AbeBooks and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
