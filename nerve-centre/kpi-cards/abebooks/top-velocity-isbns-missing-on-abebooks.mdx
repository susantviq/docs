...
Top-velocity-missing is the cross-channel coverage-gap metric. Pair with these to size, validate, and act:

| Card | Why pair it with Top-Velocity ISBNs Missing |
| --- | --- |
| [ISBN Drift vs Alibris + Amazon](/nerve-centre/kpi-cards/abebooks/isbn-drift-vs-alibris-amazon) | Sister card. "Drift" = wrong price; this = no listing. Together they bound the cross-channel revenue exposure. |
...
This card is inherently cross-channel; it requires at least one connected sibling marketplace. The reconciliation is bilateral with each sibling.
