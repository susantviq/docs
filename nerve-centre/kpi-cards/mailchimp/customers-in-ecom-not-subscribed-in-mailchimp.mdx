...
| **Why cross-channel** | The customer list is a store fact; the subscribed audience is a Mailchimp fact. The gap between them, buyers who are not subscribers, is only visible by joining both. Neither system flags it alone. |
