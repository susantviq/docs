---
title: "Abandoned-Cart Recovery Value, Mailchimp"
sidebarTitle: "Abandoned-Cart Recovery Value"
description: "$/30D recovered by the abandoned-cart automation. Goes to zero if status='save' (draft), which is exactly what audit MC01 detects. How to read it, why it ..."
---
...
This is the central purpose of this cross-channel card.
