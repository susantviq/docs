...
Position Trend is a Supporting Metrics-class trend, designed for reading direction. For a hard, fired alert when rankings drop sharply, use [Ranking-Drop Alert](/nerve-centre/kpi-cards/google-search-console/ranking-drop-alert), which watches for threshold-crossing moves rather than slope.
