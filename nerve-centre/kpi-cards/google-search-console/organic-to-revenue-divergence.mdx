...
**Metrics type:** [Sensitivity](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [Cross-Channel: Revenue at Risk](/nerve-centre/connectors#connectors-by-type)
...
| --- | --- |
| [Slow Indexed Pages (GSC × Website Performance)](/nerve-centre/kpi-cards/google-search-console/slow-indexed-pages-gsc-website-performance) | The other cross-channel revenue-at-risk card. If a divergent page is also slow, page experience is a likely cause of the broken-experience diagnosis. |
...
**The cross-channel point:** Search Console alone tells you a page gets impressions; your commerce data alone tells you a page earns little; only the join tells you Google is sending real demand to a page that wastes it. That is the row worth acting on. For divergence investigations, use Vortex Mind.
{/* /HUMAN_AUTHORED:reconcile */}
