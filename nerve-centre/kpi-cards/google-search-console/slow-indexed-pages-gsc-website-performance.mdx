...
| **Card class** | Hero, sensitivity, and cross-platform: it is a headline pulse, it is configurable per profile in the Sensitivity tab, and it draws on two connectors at once. |
