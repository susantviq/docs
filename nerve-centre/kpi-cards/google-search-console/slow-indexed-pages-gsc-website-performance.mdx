...
| **Card class** | Key Metrics, Alert Rules, and cross-platform: it is a headline pulse, it is configurable per profile in the Alert Rules tab, and it draws on two connectors at once. |
...
| --- | --- |
| [Organic-to-Revenue Divergence](/nerve-centre/kpi-cards/google-search-console/organic-to-revenue-divergence) | The other cross-platform revenue-at-risk card. Slow pages are one reason ranked traffic does not convert; this card finds the rest. |
