...
**Metrics type:** [Supporting Metrics](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [Indexing & Coverage](/nerve-centre/connectors#connectors-by-type)
...
Yes, in the Alert Rules tab per profile. Very large sites with constant catalogue turnover sometimes widen it slightly; most sites should keep it tight, because a real de-indexing event is one of the most expensive organic regressions to miss.
{/* /HUMAN_AUTHORED:faqs */}
