...
Yes, alert thresholds are configurable per profile in the Alert Rules tab. A niche where you naturally rank deep may warrant a higher threshold; a brand that lives and dies on page-1 visibility may want a tighter one. The default of >15 is set to flag when the bulk of your weighted appearances have crossed onto page 2.
{/* /HUMAN_AUTHORED:faqs */}
