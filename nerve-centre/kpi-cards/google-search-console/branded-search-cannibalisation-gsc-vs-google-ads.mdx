...
It is the default trigger, not a universal truth. A large brand may waste far more than £500 before it is worth a project; a small one may want to act below it. The threshold is configurable per profile in the Alert Rules tab; set it to the point where the potential saving justifies the test for your account size.
{/* /HUMAN_AUTHORED:faqs */}
