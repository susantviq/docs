...
| **Alert trigger** | No hard alert is wired on this card; it is a Sensitivity-class diagnostic you read alongside [Ranking-Drop Alert](/nerve-centre/kpi-cards/google-search-console/ranking-drop-alert), which carries the paging logic. |
