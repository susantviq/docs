...
Yes. The drop threshold is configurable per profile in the Sensitivity tab. Set it to match your normal volatility: a high-traffic property can use a tighter threshold, a low-traffic property a looser one to avoid noise.
{/* /HUMAN_AUTHORED:faqs */}
