...
| [Connected Clients Saturation vs Traffic Burst](/nerve-centre/kpi-cards/redis/connected-clients-saturation-vs-traffic-burst) | The cross-platform view tying saturation to storefront traffic. | Confirms whether the climb is genuine demand or a leak unrelated to traffic. |
