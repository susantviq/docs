...
| **Weight configuration.** The composite uses your profile's weights. | Either | If you changed the weights in the Alert Rules tab, your mental "what should this be" will differ from the default. |
