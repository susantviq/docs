...
3. **The 72h alert has not fired yet, but it is 17 hours away.** This is the value of a Key Metric card: the team can see the slow bleed and fix the shipping job before the alert ever pages them at 3am.
