...
sidebarTitle: "Audit"
description: "What the Vortex IQ Sendle health audit checks: Sendle: Flat-Rate Zone OTD, Pickup-Network Coverage & Cross-Platform Leak"
---
...
- Cross-platform: commerce_sibling AU/US order with no Sendle shipment after 48h -> dispatch leak
- Cross-platform: late shipments joined to order_ref -> revenue at risk per channel * sibling.order.total
- Cross-platform: flat-rate arbitrage - Sendle price_total > AusPost / EasyPost cost by zone (renegotiate or switch)
- Cross-platform: carbon_offset_grams reporting drift vs shipment volume (sustainability-badge certification risk)
