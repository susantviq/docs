...
| **Time window** | `24H` |
| **Alert trigger** | `>2%` |
| **Sentiment key** | `sen_api_error_rate` |
...
| [`sen_label_generation_success`](/nerve-centre/kpi-cards/sendle/label-generation-success) | Operational Health sibling: Label Generation Success. |
