...
- Cross-platform: SCAN-form gaps correlated with order_ref - which channels have the most invisible parcels
- Cross-platform: open claims with no Jira tracker_item -> CS coverage gap
- Cross-platform: Priority Mail upsell ROI vs First-Class (when used as alternatives on same order_ref)
