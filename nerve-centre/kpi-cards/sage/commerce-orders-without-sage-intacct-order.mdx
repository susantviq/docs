---
title: "Commerce Orders Without Sage Intacct Order, Sage"
sidebarTitle: "Commerce Orders Without Sage Intacct Order"
description: "Commerce orders that never created a Sage Intacct Order. Each row is a revenue-leak investigation. How to read it, why it matters, and how to act on it."
---
...
| --- | --- |
| [Revenue Gap, Detailed Breakdown](/nerve-centre/kpi-cards/sage/revenue-gap-detailed-breakdown) | The master cross-channel card. This card drills into the unmapped-orders bucket, which typically dominates the gap. |
