---
title: "Inventory Carrying Cost, Sage"
---
...
| | |
| --- | --- |
| **What it counts** | Estimated cost of holding aged inventory. Joined with commerce sell-through to flag dead stock with cash impact. |
...
*Inventory Carrying Cost* is one of hundreds of KPI pulses Vortex IQ tracks across Sage and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
