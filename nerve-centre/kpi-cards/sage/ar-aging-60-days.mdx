...
| [AR Aging on Customers with Active Ecom Orders](/nerve-centre/kpi-cards/sage/ar-aging-on-customers-with-active-ecom-orders) | The cross-platform kill-shot: bad debt on customers still being sold to. |
...
| --- | --- | --- |
| [AR Aging on Customers with Active Ecom Orders](/nerve-centre/kpi-cards/sage/ar-aging-on-customers-with-active-ecom-orders) | Killer cross-platform | Aged AR on a customer still placing orders means they are being extended more credit as their balance goes bad. The single highest-value finding in this family. |
