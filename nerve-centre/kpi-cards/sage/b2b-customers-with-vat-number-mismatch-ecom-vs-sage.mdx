...
| [Ecom Customers Absent from Sage Customer Master](/nerve-centre/kpi-cards/sage/ecom-customers-absent-from-sage-customer-master) | The cross-platform sync view; absent customers cannot be VAT-checked at all. |
