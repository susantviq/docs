---
title: "Revenue by Currency, Sage"
---
...
| | |
| --- | --- |
| **What it counts** | Revenue split by transaction currency. Highlights FX exposure for multi-currency accounts. |
...
*Revenue by Currency* is one of hundreds of KPI pulses Vortex IQ tracks across Sage and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
