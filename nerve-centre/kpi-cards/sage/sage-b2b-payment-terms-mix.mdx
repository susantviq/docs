---
title: "B2B Payment Terms Mix, Sage"
---
...
| | |
| --- | --- |
| **What it counts** | Mix of Net-30 / Net-60 / Net-90 / COD / Prepay across B2B customers. Drives DSO planning. |
...
*B2B Payment Terms Mix* is one of hundreds of KPI pulses Vortex IQ tracks across Sage and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
