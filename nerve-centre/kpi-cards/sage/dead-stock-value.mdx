...
| [Dead Stock with Active Ad Spend](/nerve-centre/kpi-cards/sage/dead-stock-with-active-ad-spend) | The cross-channel kill-shot: dead stock still receiving ad spend. |
...
| [Dead Stock with Active Ad Spend](/nerve-centre/kpi-cards/sage/dead-stock-with-active-ad-spend) | Killer cross-channel | Dead stock plus active Google Ads, Meta, or TikTok campaign on the SKU equals pure waste. The single highest-leverage finding any Vortex IQ subscriber gets in the first 30 days. |
