...
| [OOS with Open Order Demand](/nerve-centre/kpi-cards/sage/oos-with-open-order-demand) | Cross-platform mirror: this card is the on-hand pool, that card surfaces the demand the pool cannot fulfil. |
{/* /HUMAN_AUTHORED:siblings */}
