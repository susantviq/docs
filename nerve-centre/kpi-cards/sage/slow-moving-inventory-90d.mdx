...
| [Dead Stock with Active Ad Spend](/nerve-centre/kpi-cards/sage/dead-stock-with-active-ad-spend) | Early-warning cross-platform | Slow-moving stock receiving paid traffic and still not selling is a product or price problem, surfaced before it ages into dead. |
