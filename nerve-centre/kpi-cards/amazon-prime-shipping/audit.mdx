...
- Cross-platform: ASINs at SFP eligibility risk -> Buy Box loss exposure (amazon.listing.revenue)
- Cross-platform: late SFP shipments triggering Buy Box flips on those ASINs
- Cross-platform: A-to-z claims with no Jira tracker_item -> CS coverage gap
- Cross-platform: SFP-to-FBA migration candidates (ASINs with chronic SFP OTD &lt; 99%)
