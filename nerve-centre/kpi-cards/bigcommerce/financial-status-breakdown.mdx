...
| [BC Incomplete Rate](/nerve-centre/kpi-cards/bigcommerce/incomplete-cart-rate) | Pre-financial-status state. Incomplete orders never get a paymentStatus assigned. |
