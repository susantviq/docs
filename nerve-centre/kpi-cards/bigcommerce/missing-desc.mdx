...
| [`empty_collections`](/nerve-centre/kpi-cards/bigcommerce/empty-collections) | Empty collections compound thin-content issues. |
| [`file_errors`](/nerve-centre/kpi-cards/bigcommerce/file-errors) | Broken images compound thin-product-page issues. |
