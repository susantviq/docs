...
| [`order_count_trend`](/nerve-centre/kpi-cards/bigcommerce/order-count-trend) | Trend variant; carries the sensitivity logic. |
...
| [`failed_orders_trend`](/nerve-centre/kpi-cards/bigcommerce/failed-orders-trend) | Failed-order trend; complements successful-order count. |
{/* /HUMAN_AUTHORED:siblings */}
