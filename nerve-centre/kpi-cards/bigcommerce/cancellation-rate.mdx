...
| [BC Incomplete Rate](/nerve-centre/kpi-cards/bigcommerce/incomplete-cart-rate) | Incomplete (cart abandoned) is upstream of cancellations; high incomplete + low cancellation = abandonment problem; high cancellation + healthy incomplete = post-order problem. |
