...
4. **Pair with [BC Revenue by Currency](/nerve-centre/kpi-cards/bigcommerce/revenue-by-currency)** for the cross-platform currency rollup.
...
| --- | --- |
| [BC Revenue by Currency](/nerve-centre/kpi-cards/bigcommerce/revenue-by-currency) | The cross-platform rollup; this card is the per-channel decomposition. |
...
| [BC Channel AOV](/nerve-centre/kpi-cards/bigcommerce/aov-by-channel) | Per-channel AOV needs currency context for cross-platform comparison. |
