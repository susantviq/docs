...
| [Parcelforce OTD by Sales Channel](/nerve-centre/kpi-cards/parcelforce/parcelforce-otd-by-sales-channel) | Cross-channel. A drop that is all DTC and zero B2B reseller tells you it is a consumer-experience problem first. | Channel mix in the slip matches the channel mix of customer-service tickets a day later. Predictive of CS load. |
