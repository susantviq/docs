...
| [Parcelforce OTD by Sales Channel](/nerve-centre/kpi-cards/parcelforce/parcelforce-otd-by-sales-channel) | Cross-platform split. If Express24 misses are concentrated in a single sales channel, the issue may be cohort-specific (e.g. Friday-evening Shopify orders missing dispatch cutoff). | Channel-mix in the misses guides ops triage. |
