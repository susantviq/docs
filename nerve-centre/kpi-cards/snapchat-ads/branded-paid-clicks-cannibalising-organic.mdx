...
| [GA4 Revenue by Channel](/nerve-centre/kpi-cards/google-analytics/revenue-by-channel) | The cross-channel revenue picture. | Whether total revenue holds when branded Snapchat paid is reduced (the cannibalisation proof). |
{/* /HUMAN_AUTHORED:siblings */}
