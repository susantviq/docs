...
| **Sensitivity note** | This is an Alert Rules card: the `> 1000` default surfaces an over-partitioned table early, while it is still a tuning problem and not yet an outage. |
