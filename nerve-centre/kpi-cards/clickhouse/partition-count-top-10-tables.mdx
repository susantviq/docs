...
**Metrics type:** [Supporting Metrics](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [Ingest & Merges](/nerve-centre/connectors#connectors-by-type)
...
| **Alert Rules note** | This is an Alert Rules card: the `> 1000` default surfaces an over-partitioned table early, while it is still a tuning problem and not yet an outage. |
