...
4. Compare against the `> 200ms` alert threshold; if the rolling value stays above it for the configured dwell, the card flips to an alert state and feeds the sensitivity layer.
