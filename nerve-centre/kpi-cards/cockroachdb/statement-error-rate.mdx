...
Yes, alert thresholds are configurable per profile in the Alert Rules tab. If your workload runs a higher harmless-retry baseline (some high-contention workloads do), raise the threshold to match your normal so the alert reflects genuine deviation rather than your steady state.
{/* /HUMAN_AUTHORED:faqs */}
