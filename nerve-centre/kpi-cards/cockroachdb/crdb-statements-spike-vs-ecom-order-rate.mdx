...
| [CRDB Pool Saturation vs Traffic Burst](/nerve-centre/kpi-cards/cockroachdb/crdb-pool-saturation-vs-traffic-burst) | The sibling cross-channel card on the connection axis. | Statements and saturation both flat against traffic confirms the cluster is scaling cleanly. |
