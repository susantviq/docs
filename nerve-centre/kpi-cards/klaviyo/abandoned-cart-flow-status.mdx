...
| [Klaviyo Abandoned-Cart Recovery Value (Cross-Platform)](/nerve-centre/kpi-cards/klaviyo/abandoned-cart-recovery-value) | The dollar value of what this flow is recovering, expressed against the commerce platform's order volume. The "what's at stake if this flow goes draft" number. |
