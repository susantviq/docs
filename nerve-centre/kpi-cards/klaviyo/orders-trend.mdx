...
3. **Orders are gross.** If 60 of these 2,025 orders were refunded, this line still shows 2,025. The order count is never reduced by refunds; see [Refunds Trend](/nerve-centre/kpi-cards/klaviyo/refunds-trend) for the deduction.
...
No. Klaviyo counts the order as a conversion at placement and never removes it for a later refund. The count stays. Refund value is tracked separately in [Refunds Trend](/nerve-centre/kpi-cards/klaviyo/refunds-trend).
