---
title: "Deliverability Summary, Klaviyo"
sidebarTitle: "Deliverability Summary"
description: "Deliverability Summary for Klaviyo stores: the composite of delivery, open, click, bounce, unsubscribe and spam-complaint signals that show whether email is reaching the inbox. How to read it, why it matters, and how to act on it."
---
...
- **Klaviyo composite vs SendGrid or Postmark transactional health**: NOT definitional twins. Marketing-platform deliverability is a different concern from transactional-platform deliverability, but the cross-platform kill-shot card surfaces whether marketing-side reputation is leaking into transactional-side delivery on the same sender domain.
