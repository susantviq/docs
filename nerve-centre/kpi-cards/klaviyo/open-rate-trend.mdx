...
You can, but a fixed threshold is weak for opens because of MPP inflation. A step-change alert (a sustained drop relative to the recent baseline) is far more meaningful here than a hard floor. Alert thresholds are configurable per profile in the Alert Rules tab.
{/* /HUMAN_AUTHORED:faqs */}
