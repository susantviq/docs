...
| **Currency** | Klaviyo's revenue is reported in the merchant's primary store currency (the currency Shopify or BigCommerce returns on order events). Multi-currency stores need the cross-platform reconciliation card to handle currency normalisation properly. |
