...
description: "Open Transactions (Pending Approval / Error) for NetSuite. Tracked in the Vortex IQ Nerve Centre — how to read it, why it matters, and how to act on it."
---
...
| | |
| --- | --- |
| **What it counts** | Transactions in PENDING_APPROVAL or REJECTED status. Spike = SuiteScript integration error or approval-routing rule broken. |
...
| **Time window** | `RT` |
| **Alert trigger** | `>50` |
| **Sentiment key** | `erp_open_journal_count` |
| **Roles** | owner, finance |
{/* /HUMAN_AUTHORED:tldr */}
