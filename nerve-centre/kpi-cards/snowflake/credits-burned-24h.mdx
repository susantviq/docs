...
**Metrics type:** [Key Metrics](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [Credit Burn](/nerve-centre/connectors#connectors-by-type)
...
| **Alert trigger** | `+50% vsP`, a 50% or greater rise against the prior 24 hours raises the alert. |
...
| [Credit Burn vs Ecom Order Volume](/nerve-centre/kpi-cards/snowflake/credit-burn-vs-ecom-order-volume) | The cross-platform divergence check. | Credits up with orders flat is the clearest inefficiency signal. |
