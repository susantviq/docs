...
Yes. The divergence threshold is configurable per profile in the Sensitivity tab. A small, spiky estate may need a higher threshold to avoid noise; a large, steady estate where credits should be very predictable may want a tighter one. Tune it to your normal week-on-week variance rather than relying on the generic default.
