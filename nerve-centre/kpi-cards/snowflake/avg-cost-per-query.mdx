...
| **Alert trigger** | `+25% WoW`, a 25% or greater week-over-week rise raises the alert. |
...
| [Credit Burn vs Ecom Order Volume](/nerve-centre/kpi-cards/snowflake/credit-burn-vs-ecom-order-volume) | The cross-platform sanity check. | Cost per query up while order volume is flat is the clearest waste signal a business can read. |
