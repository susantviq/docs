...
| [Snowflake QPS Spike vs Ecom Order Rate](/nerve-centre/kpi-cards/snowflake/snowflake-qps-spike-vs-ecom-order-rate) | The volume-side cross-platform sibling. | A query storm during the checkout window is how five slow queries become fifty. |
| [Snowflake Event Ingest vs Ecom Orders](/nerve-centre/kpi-cards/snowflake/snowflake-event-ingest-vs-ecom-orders) | The ingest-side cross-platform sibling. | Slow queries plus stale data means the analytics layer is both contended and behind. |
