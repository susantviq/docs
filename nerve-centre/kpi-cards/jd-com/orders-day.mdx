...
This card has no default alert because daily volume is informational. You can add an alert rule in the Alert Rules tab to be notified when daily orders move beyond a chosen band, for example to flag a demand cliff.
{/* /HUMAN_AUTHORED:faqs */}
