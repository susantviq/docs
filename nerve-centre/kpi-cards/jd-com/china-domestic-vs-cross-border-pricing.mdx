...
| **Sample type** | Cross-platform price comparison of JD.com domestic listings against matched cross-border AliExpress/Alibaba listings, refreshed on the standard data refresh. |
...
Yes. The default fires when more than 5 SKUs exceed a 15 percent spread, but both the SKU count and the spread percentage are configurable per profile in the Alert Rules tab. Tighten them for premium categories where parity perception matters most.
{/* /HUMAN_AUTHORED:faqs */}
