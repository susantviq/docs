...
Yes, the alert floor (default 70) and the relative input weights are configurable per profile in the Sensitivity tab. Tune them to match how your category weighs ratings, catalogue health, and authorisation rather than relying on the generic default.
{/* /HUMAN_AUTHORED:faqs */}
