...
The default alert fires when any axis falls below 4.5, matching JD's safe band. You can set an earlier warning threshold per profile in the Alert Rules tab to catch a slip before it reaches JD's floor.
{/* /HUMAN_AUTHORED:faqs */}
