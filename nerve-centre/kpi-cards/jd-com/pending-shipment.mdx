...
Yes, the multiple of the 30-day average (default 2x) is configurable per profile in the Alert Rules tab. Lower it if your ship-deadlines are tight, or raise it for categories with naturally lumpy intake so routine promotion spikes do not over-alert.
{/* /HUMAN_AUTHORED:faqs */}
