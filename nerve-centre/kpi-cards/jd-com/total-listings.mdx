...
This card has no default alert (`-`). If you want to be warned when the catalogue shrinks unexpectedly, set a downward-change threshold per profile in the Alert Rules tab.
{/* /HUMAN_AUTHORED:faqs */}
