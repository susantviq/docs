...
The default fires below 95%, reflecting that JD's buyer base searches almost entirely in Chinese. You can adjust the threshold per profile in the Alert Rules tab if your buyer mix differs.
{/* /HUMAN_AUTHORED:faqs */}
