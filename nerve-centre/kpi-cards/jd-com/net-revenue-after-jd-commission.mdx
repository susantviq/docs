...
Yes, the drop-versus-prior threshold (default 10%) is configurable per profile in the Alert Rules tab. Tighten it if your margins are thin, or loosen it for categories with naturally volatile commission mix.
{/* /HUMAN_AUTHORED:faqs */}
