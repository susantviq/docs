...
The default alert fires below 95%. You can tighten or relax this per profile in the Alert Rules tab to match how aggressively you want to police attribute gaps.
{/* /HUMAN_AUTHORED:faqs */}
