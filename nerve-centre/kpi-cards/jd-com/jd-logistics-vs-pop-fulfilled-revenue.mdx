...
This card has no default alert because the ideal mix varies by category and strategy. You can add an alert rule in the Alert Rules tab if you want to be notified when either slice moves beyond a chosen band.
{/* /HUMAN_AUTHORED:faqs */}
