...
The default fires on any order past its ship deadline, which mirrors JD's own rule. If you want a buffer alert before the deadline, configure an earlier warning per profile in the Sensitivity tab.
{/* /HUMAN_AUTHORED:faqs */}
