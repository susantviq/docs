...
This card is a comparison view and ships without an alert by default. If you want to be alerted when a key province's AOV drops below a baseline, configure a threshold per profile in the Sensitivity tab.
{/* /HUMAN_AUTHORED:faqs */}
