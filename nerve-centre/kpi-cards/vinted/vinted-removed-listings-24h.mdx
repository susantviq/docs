...
By default the card flags any removal above zero, but the spike sensitivity is configurable per profile in the Alert Rules tab. Raise it if occasional single removals are normal for your catalogue volume.
{/* /HUMAN_AUTHORED:faqs */}
