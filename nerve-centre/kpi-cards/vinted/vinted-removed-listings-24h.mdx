...
| [`vin_xc_feed_rejection_vs_listings`](/nerve-centre/kpi-cards/vinted/listings-failing-feedonomics-validation) | Cross-platform sibling: feed validation failures that precede removals. |
...
By default the card flags any removal above zero, but the spike alert threshold is configurable per profile in the Alert Rules tab. Raise it if occasional single removals are normal for your catalogue volume.
{/* /HUMAN_AUTHORED:faqs */}
