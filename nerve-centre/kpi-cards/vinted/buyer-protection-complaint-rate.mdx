...
Yes, the safe band is configurable per profile in the Alert Rules tab. Set it to the complaint level your category and condition mix can reasonably sustain rather than the generic default.
{/* /HUMAN_AUTHORED:faqs */}
