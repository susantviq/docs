...
| --- | --- |
| [`bon_xc_price_parity`](/nerve-centre/kpi-cards/bonanza/price-drift-vs-ebay-etsy-via-importer) | Cross-Channel: Revenue at Risk sibling: Price Drift vs eBay / Etsy via Importer. |
...
| [`bon_xc_feed_rejection_vs_listings`](/nerve-centre/kpi-cards/bonanza/listings-failing-feedonomics-validation) | Cross-Channel: Revenue at Risk sibling: Listings Failing Feedonomics Validation. |
...
In Bonanza, open the selling area and your item listings to inspect the flagged SKUs, then compare each against the source product in your BigCommerce catalog. Because this is a cross-channel card, the truth lives in two places: the Bonanza listing and the upstream BC record that should drive it.
