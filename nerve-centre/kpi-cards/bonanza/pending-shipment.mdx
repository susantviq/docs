...
The alert compares the live count against your trailing 30-day average, so a genuine surge above twice that baseline will trip it even if each individual order is on track. If your business is seasonal, raise the threshold in the Sensitivity tab to match your real peak pattern.
