...
| --- | --- |
| [`clr_top_traffic_sources`](/nerve-centre/kpi-cards/clarity/top-traffic-sources) | Gives the Clarity-side source ranking this card pairs with revenue. |
...
| [`clr_session_conversion_rate`](/nerve-centre/kpi-cards/clarity/session-conversion-rate) | Confirms whether a high-session, low-revenue source is a conversion problem. |
{/* /HUMAN_AUTHORED:siblings */}
