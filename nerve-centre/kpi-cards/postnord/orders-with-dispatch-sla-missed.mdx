...
5. **This card is the leading edge of revenue-at-risk.** A dispatch miss today is a late delivery in 1 to 3 days and a possible return or refund in 7 to 14. Acting now (clear the floor backlog, fix the CN23 feed) is far cheaper than absorbing the refund and the review damage later. That is why it sits in the Cross-Platform: Revenue at Risk class.
{/* /HUMAN_AUTHORED:worked_example */}
