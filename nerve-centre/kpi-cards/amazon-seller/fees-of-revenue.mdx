...
Yes. The `>35%` default is configurable per profile in the Alert Rules tab. Set it just above your normal baseline so the alert fires on genuine drift rather than on your steady-state fee load.
{/* /HUMAN_AUTHORED:faqs */}
