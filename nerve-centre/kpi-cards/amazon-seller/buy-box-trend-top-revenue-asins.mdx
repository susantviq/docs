...
Yes. The `drop >5pp WoW` default is configurable per profile in the Alert Rules tab. Tighten it if you run thin-margin ASINs where small Buy Box losses hurt, loosen it if your category is naturally volatile.
{/* /HUMAN_AUTHORED:faqs */}
