...
| [Spend on Campaigns with Active Feed Rejections](/nerve-centre/kpi-cards/criteo/spend-on-campaigns-with-active-feed-rejections) | The cross-platform root-cause card. | If both fire, the burst is confirmed feed-driven and you have the exact rejecting catalogue named. |
