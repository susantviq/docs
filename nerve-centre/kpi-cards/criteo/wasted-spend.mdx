...
| [Google Ads Wasted Spend](/nerve-centre/kpi-cards/google-ads/wasted-spend) | Different funnel position; cross-platform waste check. | Google Ads waste is keyword-driven; Criteo waste is audience and catalogue-driven. Different fixes. |
{/* /HUMAN_AUTHORED:siblings */}
...
| [`google_ads.gads_wasted_spend`](/nerve-centre/kpi-cards/google-ads/wasted-spend) | Cross-platform waste pattern. | Google waste is keyword-level; Criteo is audience and catalogue-level. Different shapes. |
