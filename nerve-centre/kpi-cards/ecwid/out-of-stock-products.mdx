...
Not natively; you need to configure the auto-pause in your ad platform's product feed integration. The cross-platform ads-on-OOS card surfaces this gap if the merchant runs ads.
