...
| [Total Products](/nerve-centre/kpi-cards/ecwid/total-products) | Catalogue context. | Frames how much of your range is exposed to cross-platform mismatch. |
{/* /HUMAN_AUTHORED:siblings */}
...
No. This is a cross-platform card; the "active elsewhere" half comes from a connected marketplace. Without one, Vortex IQ knows what is OOS on Ecwid but cannot see your marketplace listings, so there is nothing to compare.
