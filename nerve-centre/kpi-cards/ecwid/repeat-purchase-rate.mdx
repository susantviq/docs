---
title: "Repeat Purchase Rate, Ecwid"
...
| **Time window** | `90D` |
| **Alert trigger** | `<20%` |
| **Sentiment key** | `ecwid_repeat_rate` |
...
| --- | --- |
| [`ecwid_new_customers`](/nerve-centre/kpi-cards/ecwid/new-customers) | Customer Health sibling: New Customers. |
...
*Repeat Purchase Rate* is one of hundreds of KPI pulses Vortex IQ tracks across Ecwid and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
