---
title: "New Customers, Ecwid"
sidebarTitle: "New Customers"
description: "New Customers for Ecwid stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D vsP` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `ecwid_new_customers` |
...
| --- | --- |
| [`ecwid_repeat_rate`](/nerve-centre/kpi-cards/ecwid/repeat-purchase-rate) | Customer Health sibling: Repeat Purchase Rate. |
...
*New Customers* is one of hundreds of KPI pulses Vortex IQ tracks across Ecwid and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
