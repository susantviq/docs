...
Yes, the threshold and window are configurable per profile in the Alert Rules tab. A very high-volume warehouse may tolerate a slightly lower floor to avoid paging on small bursts; a low-volume merchant where every parcel matters may want a tighter floor.
