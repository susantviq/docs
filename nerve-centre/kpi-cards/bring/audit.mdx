...
- Cross-platform: Bring shipment late vs expected_delivery joined to commerce_sibling order -> revenue at risk per channel
- Cross-platform: NO/Nordic order with no Bring shipment after 48h (dispatch SLA breach)
- Cross-platform: Bring cost_nok vs PostNord cost (FX-adjusted) per to_country_code -> carrier-mix leak
- Cross-platform: Mypack shipment past pickup-expiry with no proactive customer contact
