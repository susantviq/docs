...
| **Warning-window definition** | Ours wider or narrower | The card's 48-hour warning window is a Vortex IQ setting, not a Bring field. Mybring shows the absolute deadline; we show "expiring soon" relative to a threshold you can tune in the Alert Rules tab. |
