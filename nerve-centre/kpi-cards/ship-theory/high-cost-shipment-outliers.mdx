---
title: "High-Cost Shipment Outliers, ShipTheory"
sidebarTitle: "High-Cost Shipment Outliers"
description: "High-Cost Shipment Outliers for ShipTheory stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| | |
| --- | --- |
| **What it counts** | High-Cost Shipment Outliers as exposed by the ShipTheory integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
*High-Cost Shipment Outliers* is one of hundreds of KPI pulses Vortex IQ tracks across ShipTheory and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
