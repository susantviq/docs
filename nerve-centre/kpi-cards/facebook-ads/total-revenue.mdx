...
| [Klaviyo Email Revenue](/nerve-centre/kpi-cards/klaviyo/email-attributed-revenue) | Cross-platform sanity check. | Email and Meta both claim revenue from the same purchase if attribution is naive last-click. |
{/* /HUMAN_AUTHORED:siblings */}
