...
| **Alert trigger** | Zero-conversion spend above a configured floor in the last 72 hours on any ad set. The floor is tunable per profile in the Alert Rules tab so it matches the spend level you consider material. |
