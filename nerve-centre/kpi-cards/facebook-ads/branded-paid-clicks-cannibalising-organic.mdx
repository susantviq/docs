...
| **Alert trigger** | Fires when more than roughly 30% of branded paid clicks are estimated to have been free organic, the level at which a lift test or a pause is usually worth it. Tunable per profile in the Alert Rules tab. |
