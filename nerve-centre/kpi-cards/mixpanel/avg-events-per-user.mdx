...
This card ships without a fixed threshold because it is a trend and context metric, but you can configure a threshold or watch condition per profile in the Alert Rules tab if you want it to alert on large swings for your store.
{/* /HUMAN_AUTHORED:faqs */}
