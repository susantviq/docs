...
**Metrics type:** [Key Metrics](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [Retention](/nerve-centre/connectors#connectors-by-type)
...
Yes, the 5pp drop threshold and the baseline window are configurable per profile in the Alert Rules tab. Tighten it for high-volume stores where small movements are meaningful, or loosen it for low-traffic stores whose cohorts are naturally noisy.
{/* /HUMAN_AUTHORED:faqs */}
