...
Yes, the 25% threshold and the baseline length are configurable per profile in the Alert Rules tab. High-volume stores can tighten it; low-volume or spiky stores may want a looser threshold to cut noise.
{/* /HUMAN_AUTHORED:faqs */}
