...
Yes, the engagement and abandonment levels, and how the two must move relative to each other, are configurable per profile in the Alert Rules tab. Tighten them if your checkout is usually stable and you want early warning, loosen them for seasonal periods where abandonment naturally rises.
{/* /HUMAN_AUTHORED:faqs */}
