...
This card is a ranking with no default alert, but you can configure thresholds per profile in the Alert Rules tab, for example to be notified when a named event leaves the top ten or when an unexpected event enters it.
{/* /HUMAN_AUTHORED:faqs */}
