...
Yes, the 20% floor is configurable per profile in the Sensitivity tab. Stores with naturally high daily habit can raise it for an earlier warning, while lower-frequency stores may lower it to cut noise.
{/* /HUMAN_AUTHORED:faqs */}
