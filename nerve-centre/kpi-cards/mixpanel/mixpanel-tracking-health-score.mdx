...
Yes, the score's alert floor is configurable per profile in the Alert Rules tab. Stores with steady volume can raise the floor for an earlier warning, while spiky or low-volume stores may lower it to cut noise.
{/* /HUMAN_AUTHORED:faqs */}
