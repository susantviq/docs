...
| [GA4 Revenue by Channel](/nerve-centre/kpi-cards/google-analytics/revenue-by-channel) | The cross-channel revenue picture. | Whether total revenue holds when branded TikTok paid is reduced (the cannibalisation proof). |
