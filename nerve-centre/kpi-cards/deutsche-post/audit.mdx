...
sidebarTitle: "Audit"
description: "What the Vortex IQ Deutsche Post / DHL Parcel health audit checks: Deutsche Post / DHL Parcel: German OTD, Retouren-Etikett Compliance, EU Customs Lanes & Cross-Platform Leak"
---
...
- Cross-platform: ecom order with no DHL shipment after 48h -> fulfilment leak per channel
- Cross-platform: Retouren-Etikett generation failure rate > 2% -> blocks German Widerruf compliance, revenue + legal risk
- Cross-platform: EU cross-border parcels stuck AwaitingCustoms > 3 days joined to sibling orders -> refund-propensity * order.total
- Cross-platform: DHL Parcel cost per zone > 10% above DPD / PostNord / Hermes sibling -> carrier renegotiation candidate
- Cross-platform: late-delivery refund-propensity * sibling.order.total by zone (Inland / EU / Welt)
