...
title: "Orders, eBay"
sidebarTitle: "Orders"
description: "Orders for eBay stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Alert trigger** | `â€”` |
| **Sentiment key** | `ebay_order_count` |
...
*Orders* is one of hundreds of KPI pulses Vortex IQ tracks across eBay and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
