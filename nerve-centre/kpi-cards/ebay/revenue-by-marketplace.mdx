---
title: "Revenue by Marketplace, eBay"
sidebarTitle: "Revenue by Marketplace"
description: "Revenue by Marketplace for eBay stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `ebay_revenue_by_marketplace` |
...
| [`ebay_top_listings`](/nerve-centre/kpi-cards/ebay/top-listings-by-revenue) | Revenue & Sales sibling: Top Listings by Revenue. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Revenue by Marketplace update?**
...
**Q: How does Revenue by Marketplace relate to other revenue & sales metrics?**
...
*Revenue by Marketplace* is one of hundreds of KPI pulses Vortex IQ tracks across eBay and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
