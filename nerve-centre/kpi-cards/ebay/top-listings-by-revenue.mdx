---
title: "Top Listings by Revenue, eBay"
sidebarTitle: "Top Listings by Revenue"
description: "Top Listings by Revenue for eBay stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `ebay_top_listings` |
...
| [`ebay_order_count`](/nerve-centre/kpi-cards/ebay/orders) | Revenue & Sales sibling: Orders. |
| [`ebay_revenue_by_marketplace`](/nerve-centre/kpi-cards/ebay/revenue-by-marketplace) | Revenue & Sales sibling: Revenue by Marketplace. |
| [`ebay_revenue_trend`](/nerve-centre/kpi-cards/ebay/revenue-over-time) | Revenue & Sales sibling: Revenue Over Time. |
...
*Top Listings by Revenue* is one of hundreds of KPI pulses Vortex IQ tracks across eBay and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
