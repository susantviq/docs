...
Cross-platform cards (ad spend on OOS products, email share of revenue, pagespeed-driven cart loss) light up when a Big Cartel store is paired with Google Ads, Klaviyo, Mailchimp, or a website performance source.

## Detailed KPI cards in active development

The Big Cartel adapter is in build. Each KPI card documents the exact Big Cartel API resource used, the calculation, why it matters, and the playbook for when sentiment moves. Cards follow the hero / non-hero / cross-platform layout used across the Nerve Centre and respect the lighter dataset a typical Big Cartel store has, with sensible thresholds for very small product counts.
