---
title: "DSP Reach, Amazon Ads"
sidebarTitle: "DSP Reach"
description: "DSP Reach for Amazon Ads stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `-` |
| **Sentiment key** | `ama_amzn_dsp_reach` |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does DSP Reach update?**
...
**Q: How does DSP Reach relate to other dsp overlay metrics?**
...
*DSP Reach* is one of hundreds of KPI pulses Vortex IQ tracks across Amazon Ads and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
