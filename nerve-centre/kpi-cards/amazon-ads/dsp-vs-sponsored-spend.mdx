---
title: "DSP vs Sponsored Spend, Amazon Ads"
sidebarTitle: "DSP vs Sponsored Spend"
description: "DSP vs Sponsored Spend for Amazon Ads stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `-` |
| **Sentiment key** | `ama_amzn_dsp_cost_share` |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does DSP vs Sponsored Spend update?**
...
**Q: How does DSP vs Sponsored Spend relate to other dsp overlay metrics?**
...
*DSP vs Sponsored Spend* is one of hundreds of KPI pulses Vortex IQ tracks across Amazon Ads and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
