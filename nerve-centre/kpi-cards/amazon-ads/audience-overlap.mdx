---
title: "Audience Overlap (AMC), Amazon Ads"
sidebarTitle: "Audience Overlap (AMC)"
description: "% of DSP-reached audiences that also saw Sponsored Products / Brands creative, true unduplicated reach. How to read it, why it matters, and how to act on it."
---
...
> % of DSP-reached audiences that also saw Sponsored Products / Brands creative, true unduplicated reach.

## At a glance

{/* HUMAN_AUTHORED:tldr */}
> **Audience Overlap (AMC)** is a dsp overlay metric tracked from Amazon Ads data. It surfaces operational signal at the dsp overlay layer so merchants can spot regressions, opportunities, and structural patterns in their store performance. The card pairs with sibling metrics in the DSP Overlay category to build a complete diagnostic picture; cross-reference the related cards listed below for context.

| | |
| --- | --- |
| **What it counts** | Audience Overlap (AMC) as exposed by the Amazon Ads integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Time window** | `90D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `amzn_ads_dsp_audience_overlap` |
...
| [`amzn_ads_dsp_creative_fatigue`](/nerve-centre/kpi-cards/amazon-ads/dsp-creative-fatigue-alert) | DSP Overlay sibling: DSP Creative Fatigue Alert. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Audience Overlap (AMC) update?**
...
**Q: How does Audience Overlap (AMC) relate to other dsp overlay metrics?**
...
*Audience Overlap (AMC)* is one of hundreds of KPI pulses Vortex IQ tracks across Amazon Ads and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
