...
Label-generation success is the universal Key Metrics card across shipping connectors. The semantics are essentially identical; the carrier mix and failure-mode distribution differ.
