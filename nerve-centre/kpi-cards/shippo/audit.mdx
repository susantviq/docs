...
sidebarTitle: "Audit"
description: "What the Vortex IQ Shippo health audit checks: Shippo: Orca ETA Accuracy, Returns-Label Health & Cross-Platform Dispatch Leak"
---
...
- Cross-platform: ecom order has no matching Shippo shipment after 48h -> revenue at risk per channel
- Cross-platform: actual delivery > Orca-predicted ETA by > 24h -> over-promised at checkout, CS escalation candidate
- Cross-platform: tracking-event gap > 24h joined to commerce_sibling order -> proactive Klaviyo email candidate
- Cross-platform: cost per parcel by zone > 10% above direct-carrier sibling (Shippo aggregation premium)
- Cross-platform: late-delivery refund-propensity * sibling.order.total -> revenue exposure
