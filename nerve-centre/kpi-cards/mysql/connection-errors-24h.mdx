...
Yes. The `> 100` trigger is the default sensitivity. A small instance with a couple of well-behaved clients might alert at 25; a large multi-tenant fleet with aggressive health checks might set it to 500 to cut noise. Adjust it per profile in the Alert Rules tab so the alert reflects your own baseline rather than the generic default.
{/* /HUMAN_AUTHORED:faqs */}
