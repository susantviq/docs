...
| [Slow Queries During Checkout Window (5m)](/nerve-centre/kpi-cards/mysql/slow-queries-during-checkout-window-5m) | The cross-channel revenue framing. | Confirms whether the error spike overlaps the storefront's revenue-critical path. |
{/* /HUMAN_AUTHORED:siblings */}
