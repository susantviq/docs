...
sidebarTitle: "Audit"
description: "What the Vortex IQ AdRoll health audit checks: AdRoll: Spend Pacing, Retargeting ROAS & Cross-Platform Leak"
---
...
- Cross-platform retargeting ROAS per campaign below merchant target (/api/v1/report/timeseries)
