...
Yes. The expected-conversion ratio and the firing-rate floor are both configurable per profile in the Sensitivity tab. Tighten them on high-spend retargeting accounts where even a short break is costly; loosen them on low-volume accounts where small samples are noisy.
{/* /HUMAN_AUTHORED:faqs */}
