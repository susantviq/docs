...
| **Conversion attribution** | AdRoll claims these conversions under its default 30-day click + 1-day view window via the AdRoll Pixel; the cross-platform question is how many were incremental versus inevitable. This card estimates the inevitable share. |
...
| **Attribution overlap** | Ours conservative | Where AdRoll and organic both claim the same conversion, the cross-platform join apportions rather than double-counts, which can read lower than a naive overlap. |
