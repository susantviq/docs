---
title: "Total Shipping Revenue, Shopline"
sidebarTitle: "Total Shipping Revenue"
description: "Total Shipping Revenue for Shopline stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `shopline_total_shipping` |
...
| --- | --- |
| [`shopline_discount_pct`](/nerve-centre/kpi-cards/shopline/discount-of-revenue) | Revenue & Sales sibling: Discount % of Revenue. |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Total Shipping Revenue update?**
...
**Q: How does Total Shipping Revenue relate to other revenue & sales metrics?**
...
*Total Shipping Revenue* is one of hundreds of KPI pulses Vortex IQ tracks across Shopline and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
