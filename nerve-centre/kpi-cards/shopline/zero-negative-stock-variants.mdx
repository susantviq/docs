...
Almost always tail SKUs the merchant has long-term ignored. The healthy action is to either restock or archive them. Tail OOS pollutes the count and de-sensitises the alert; archiving cleans both.
