---
title: "Revenue by Channel, Shopline"
sidebarTitle: "Revenue by Channel"
description: "Storefront vs social-commerce vs POS. Single-channel today; gains depth when multi-channel Pattern A lands. How to read it, why it matters, and how to act ..."
---
...
| | |
| --- | --- |
| **What it counts** | Revenue by Channel as exposed by the Shopline integration. The metric is computed from the latest available data and refreshed on the standard data refresh. |
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `shopline_revenue_by_channel` |
...
**Q: How does Revenue by Channel relate to other geography & channel metrics?**
...
*Revenue by Channel* is one of hundreds of KPI pulses Vortex IQ tracks across Shopline and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
