...
| **Alert trigger** | `JWT exp < 30 days OR auth failures > 3 consecutive`. Key Metrics tier; this card has direct revenue-protection value because every other Shopline card depends on this token working. |
