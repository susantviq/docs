---
title: "Orders Over Time, Shopline"
sidebarTitle: "Orders Over Time"
description: "Orders Over Time for Shopline stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Orders Over Time update?**
...
**Q: How does Orders Over Time relate to other revenue & sales metrics?**
...
*Orders Over Time* is one of hundreds of KPI pulses Vortex IQ tracks across Shopline and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
