---
title: "Total Tax Collected, Shopline"
sidebarTitle: "Total Tax Collected"
description: "Total Tax Collected for Shopline stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `shopline_total_tax` |
| **Roles** | owner, finance |
{/* /HUMAN_AUTHORED:tldr */}
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Total Tax Collected update?**
...
**Q: How does Total Tax Collected relate to other revenue & sales metrics?**
...
*Total Tax Collected* is one of hundreds of KPI pulses Vortex IQ tracks across Shopline and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
