---
title: "Recurring Charge Failure Rate, Stripe"
sidebarTitle: "Recurring Charge Failure Rate"
description: "Recurring Charge Failure Rate for Stripe stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D` |
| **Alert trigger** | `>12%` |
| **Sentiment key** | `stripe_recurring_failure_rate` |
...
| [`stripe_dunning_recovery_rate`](/nerve-centre/kpi-cards/stripe/dunning-recovery-rate) | Subscription & Recurring sibling: Dunning Recovery Rate. |
| [`stripe_involuntary_churn`](/nerve-centre/kpi-cards/stripe/involuntary-churn) | Subscription & Recurring sibling: Involuntary Churn (failed payments). |
| [`stripe_mrr`](/nerve-centre/kpi-cards/stripe/monthly-recurring-revenue) | Subscription & Recurring sibling: Monthly Recurring Revenue. |
...
*Recurring Charge Failure Rate* is one of hundreds of KPI pulses Vortex IQ tracks across Stripe and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
