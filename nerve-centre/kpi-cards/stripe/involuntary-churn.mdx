---
title: "Involuntary Churn (failed payments), Stripe"
sidebarTitle: "Involuntary Churn (failed payments)"
description: "% of MRR lost when card declines couldn't recover via Smart Retries / dunning. Direct recoverable revenue. How to read it, why it matters, and how to act o..."
---
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does Involuntary Churn (failed payments) update?**
...
**Q: How does Involuntary Churn (failed payments) relate to other subscription & recurring metrics?**
...
*Involuntary Churn (failed payments)* is one of hundreds of KPI pulses Vortex IQ tracks across Stripe and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
