---
title: "Active Subscriptions, Stripe"
sidebarTitle: "Active Subscriptions"
description: "Active Subscriptions for Stripe stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `RT` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `stripe_active_subscriptions` |
...
| [`stripe_recurring_failure_rate`](/nerve-centre/kpi-cards/stripe/recurring-charge-failure-rate) | Subscription & Recurring sibling: Recurring Charge Failure Rate. |
...
*Active Subscriptions* is one of hundreds of KPI pulses Vortex IQ tracks across Stripe and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
