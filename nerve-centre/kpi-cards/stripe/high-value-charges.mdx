---
title: "High-Value Charges, Stripe"
sidebarTitle: "High-Value Charges"
description: "High-Value Charges for Stripe stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Sentiment key** | `stripe_high_value_charges` |
...
{/* HUMAN_AUTHORED:faqs */}
**Q: How often does High-Value Charges update?**
...
**Q: How does High-Value Charges relate to other revenue & sales metrics?**
...
*High-Value Charges* is one of hundreds of KPI pulses Vortex IQ tracks across Stripe and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
