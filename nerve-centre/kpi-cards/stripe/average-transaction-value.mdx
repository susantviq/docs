---
title: "Average Transaction Value, Stripe"
sidebarTitle: "Average Transaction Value"
description: "Average Transaction Value for Stripe stores. Tracked live in Vortex IQ Nerve Centre. How to read it, why it matters, and how to act on it."
---
...
| **Time window** | `30D vsP` |
| **Alert trigger** | `â€”` |
| **Sentiment key** | `stripe_avg_transaction` |
| **Roles** | owner, finance |
{/* /HUMAN_AUTHORED:tldr */}
...
*Average Transaction Value* is one of hundreds of KPI pulses Vortex IQ tracks across Stripe and 70+ other ecommerce connectors. Nerve Centre runs the detection layer; Vortex Mind investigates the cause when something moves; Ask Viq lets you interrogate any number in plain English.
