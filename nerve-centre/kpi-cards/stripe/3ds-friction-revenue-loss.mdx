...
| [Decline vs Funnel](/nerve-centre/kpi-cards/stripe/decline-spike-vs-checkout-funnel-drop) | The companion cross-platform card. 3DS-driven funnel drops show up there as funnel-only movement (no decline-rate spike). |
| [Recoverable Revenue (decline-driven)](/nerve-centre/kpi-cards/stripe/recoverable-revenue) | Sister cross-platform card. Where this card covers SCA friction, that one covers soft-decline retries. Two different recovery motions. |
...
End-to-end: a UK or EU merchant should pair this card with [3DS Success Rate](/nerve-centre/kpi-cards/stripe/3ds-success-rate) for the rate context and [Decline vs Funnel](/nerve-centre/kpi-cards/stripe/decline-spike-vs-checkout-funnel-drop) for the cross-platform correlation.
