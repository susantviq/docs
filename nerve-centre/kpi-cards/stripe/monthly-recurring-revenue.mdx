...
| [`stripe_xc_recoverable_revenue`](/nerve-centre/kpi-cards/stripe/recoverable-revenue) | Cross-platform view combining MRR-at-risk with recoverable declines, dunning queue, and upgrade pipeline to size the next-30-day forward revenue picture. |
