...
| [Catalogue Drift](/nerve-centre/kpi-cards/adobe-commerce/catalogue-drift) | Sister cross-channel card. Drift can be a symptom of upstream incident (failed sync job). |
