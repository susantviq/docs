...
| **Alert trigger** | `>90%`. Saturation above 90%, sustained over the 1-minute window, raises an alert. By 90% you have very little margin before connection refusals begin. |
...
| [MongoDB Health Score](/nerve-centre/kpi-cards/mongodb/mongodb-health-score) | A sustained red saturation should pull the health score down. | If the score stays green during a saturation breach, check its capacity weighting in the alert profile. |
{/* /HUMAN_AUTHORED:reconcile */}
