...
| **Alert trigger** | `>20%`. A skew above 20% raises an alert: one shard holds enough of an excess that it has effectively become a hot shard and the cluster is no longer balanced. |
