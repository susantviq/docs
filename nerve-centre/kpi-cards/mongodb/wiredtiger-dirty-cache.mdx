...
**Metrics type:** [Supporting Metrics](/nerve-centre/overview#metrics-types-explained)  •  **Category:** [WiredTiger](/nerve-centre/connectors#connectors-by-type)
...
| **Alert trigger** | `>20%`. A dirty fraction above 20% raises an alert because it is the point at which WiredTiger's eviction machinery begins working hard and write throttling becomes likely. |
...
| [MongoDB Health Score](/nerve-centre/kpi-cards/mongodb/mongodb-health-score) | A sustained dirty-cache breach should pull the health score down. | If the score stays green during a breach, check its write-health weighting in the alert profile. |
{/* /HUMAN_AUTHORED:reconcile */}
