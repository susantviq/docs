...
| **Alert trigger** | Clicks rising or steady while UET conversions run well under half their expected level for a sustained short period. The exact alert threshold is tuned per account. |
