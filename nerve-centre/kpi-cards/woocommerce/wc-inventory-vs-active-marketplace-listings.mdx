...
description: "WC Inventory vs Active Marketplace Listings. SKUs that are out of stock on WooCommerce but still selling on Amazon or eBay, the highest-priority cross-channel diagnostic. How to read it, why it matters, and how to act on it."
---
