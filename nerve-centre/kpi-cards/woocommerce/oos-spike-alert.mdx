---
title: "Stock-Out Burst (multiple SKUs OOS in <1h), WooCommerce"
sidebarTitle: "Stock-Out Burst (multiple SKUs OOS in <1h)"
description: "Stock-Out Burst (multiple SKUs OOS in <1h). Unusual stock-out velocity, viral SKU, fulfilment glitch, or stock-sync plugin failure. Investigate before ad spend wastes. How to read it, why it matters, and how to act on it."
---
