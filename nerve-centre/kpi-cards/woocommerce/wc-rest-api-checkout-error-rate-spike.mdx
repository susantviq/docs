...
A self-hosted WooCommerce 8.4 store on shared hosting auto-updates a payment-gateway plugin overnight. The update ships a fatal incompatibility with the active PHP version. The store wakes up to a Hero alert.
