...
Yes. The `>5` default is a generic baseline. High-volume stores should raise it; very low-volume stores may want it lower. Adjust per profile in the Alert Rules tab so the alert reflects your own normal day.
{/* /HUMAN_AUTHORED:faqs */}
