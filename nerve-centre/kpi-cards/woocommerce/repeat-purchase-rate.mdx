---
title: "Repeat Customer Rate, WooCommerce"
sidebarTitle: "Repeat Customer Rate"
description: "Repeat Customer Rate. Customers with >=2 orders / total customers. Below 25% on a 90D window = retention is broken; above 40% = strong base for win-back automations. How to read it, why it matters, and how to act on it."
---
