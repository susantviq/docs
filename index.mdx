...
<div data-product-guide-index className="flex w-full flex-col gap-8 max-w-5xl mx-auto px-4 md:px-8 lg:px-12 py-10 lg:gap-14 lg:py-16">
  <div className="flex max-w-[540px] flex-col gap-2 self-center text-center">
    ...
    <p className="text-balance text-base leading-relaxed tracking-tight text-gray-600 dark:text-gray-400">
      Start with the outcome you need, then follow the setup, monitoring and action guides for the AI OS for ecommerce.
    </p>
  </div>

  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <a
      href="/start-here/stop-revenue-leaks"
    ...
    >
      <Icon icon="shield-exclamation" color="rgb(var(--primary))" size={18} className="shrink-0" />
      <div className="flex flex-col gap-1">
        <span className="font-serif text-base font-medium text-gray-900 dark:text-gray-50">Stop revenue leaks</span>
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Find and fix the silent problems costing you sales, with an undo point on every change.
        </span>
      </div>
    </a>
    <a
      href="/start-here/accelerate-growth"
      className="rounded-2xl flex flex-col gap-4 border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
    >
      <Icon icon="arrow-trend-up" color="rgb(var(--primary))" size={18} className="shrink-0" />
      <div className="flex flex-col gap-1">
        <span className="font-serif text-base font-medium text-gray-900 dark:text-gray-50">Accelerate growth</span>
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Turn missed demand and wasted marketing spend into revenue you approve before it publishes.
        </span>
      </div>
    </a>
  </div>
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Real-time KPI monitoring with over 7,000 cards across more than 200 connectors.
        </span>
      </div>
    </a>
    <a
      href="/integrations/connector-catalogue"
      className="rounded-2xl flex flex-col gap-4 border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
    >
