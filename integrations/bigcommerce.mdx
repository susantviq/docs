...
description: "Connect BigCommerce to Vortex IQ for 115 KPI cards - channel revenue, orders, inventory, and customer data - plus cross-platform Vortex Mind diagnostics."
---
...
When you also connect ad platforms or other data sources alongside BigCommerce, Vortex IQ unlocks additional cross-platform cards:
