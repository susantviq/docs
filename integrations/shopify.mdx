...
description: "Connect Shopify to Vortex IQ for 78 KPI cards, cross-platform alerts, Vortex Staging for safe deploys, and Vortex Backup for instant rollback."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Inventory" icon="warehouse">
    ...
    **Stock vs Sales** - Shows non-OOS variants heading toward stockout before they hit zero.
  ...
  <Card title="Store health and alerts" icon="heart-pulse">
    ...
    **Negative Review Burst Alert** - Fires on a sudden spike in low-rating signals.
  </Card>
</CardGroup>
