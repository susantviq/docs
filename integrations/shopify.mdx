...
description: "Connect Shopify to Vortex IQ for 78 KPI cards, cross-channel alerts, Vortex Staging for safe deploys, and Vortex Backup for instant rollback."
---
...
| Card | What it shows |
|------|---------------|
| Active Ads on Out-of-Stock SKUs | Ad spend burning on variants with zero inventory — the highest-ROI cross-channel pause |
