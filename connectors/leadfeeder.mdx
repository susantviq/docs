...
<Tabs>
  ...
  <Tab title="Audit (0)">
    ...
    No automated checks are defined for Leadfeeder yet. The performance signals cover the monitoring layer, and checks arrive with the connector's audit module.
