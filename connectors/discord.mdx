...
[Connect or manage this source](https://app.vortexiq.ai/workbench/settings/sources) &middot; [How connecting works](/integrations/connector-catalogue) &middot; [Create a workflow](https://app.vortexiq.ai/workbench/flows/create?connector=discord)
...
<Tabs>
  ...
  <Tab title="Audit (0)">
    ...
    No automated checks are defined for Discord yet. The performance signals cover the monitoring layer, and checks arrive with the connector's audit module.
